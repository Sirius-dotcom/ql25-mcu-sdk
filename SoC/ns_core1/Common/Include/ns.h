...
#define ONCHIP_ILM_BASE                       (0x09000000UL)          /*!< (ILM       ) Base Address */
#define ONCHIP_ILM_SIZE                       (0x10000)
#define ONCHIP_DLM_BASE                       (0x09010000UL)          /*!< (DLM       ) Base Address */
...
#define ILM_LOCAL_BASE (0x09000000U)
#define ILM_SIZE_IN_BYTE (0x10000U)
#define DLM_LOCAL_BASE (0x09010000U)
#define DLM_SIZE_IN_BYTE (0x8000U)

#define ILM_SYSTEM_BASE (0x9000000U)
#define DLM_SYSTEM_BASE (0x9000000U+0x10000U)
