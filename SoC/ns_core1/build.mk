...
include $(NUCLEI_SDK_SOC)/ns_core1_feature.mk
# available core list can be found in $(NUCLEI_SDK_BUILD)/Makefile.core
override CORE := core1_n300f
...
OPENOCD_CFG   ?= $(NUCLEI_SDK_SOC_BOARD)/openocd_ns_core1.cfg
LINKER_SCRIPT ?= $(NUCLEI_SDK_SOC_BOARD)/Source/GCC/gcc_ns_core1_$(DOWNLOAD).ld
...
CORE1_N300F_CORE_ARCH_ABI = rv32imafc ilp32f nuclei-300-series
...
ASM_SRCS += $(NUCLEI_SDK_SOC_COMMON)/Source/GCC/startup_ns_core1.S \
	        $(NUCLEI_SDK_SOC_COMMON)/Source/GCC/intexc_ns_core1.S \
			$(NUCLEI_SDK_SOC_COMMON)/Source/GCC/intexc_ns_core1_s.S
