...
{
    QSPI_ITConfig(QSPI1,QSPI_IE_DONE,ENABLE);
...
{
    if (RESET != QSPI_GetFlag(QSPI1, QSPI_STATUS_DONE)) {
        QSPI_ClearFlag(QSPI1,QSPI_STATUS_DONE);
        send_flag=1;
    } 
}
...
void main(void)
{
    ...
    QSPI_ITConfig(QSPI1, QSPI_IE_TX_DONE,ENABLE);
