...
void main(void)
{
    ...
    Spi_NorFlash_Read(QSPI1, FLASH_FastReadDual, read_buf, FLASH_ADDR, FLASH_PAGESIZE);
    if (0 == memcmp(write_buf, read_buf, FLASH_PAGESIZE)) {
    ...
    Spi_NorFlash_Read(QSPI1, FLASH_FastReadQuad, read_buf, FLASH_ADDR, FLASH_PAGESIZE);
    if (0 == memcmp(write_buf, read_buf, FLASH_PAGESIZE)) {
