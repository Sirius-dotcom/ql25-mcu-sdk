...
void main(void)
{
    ...
    dst_base_addr1 = (uint32_t *)(0x8000000 + 32768 - 0x400);
    src_base_addr1 = (uint32_t *)(0x8000000 + 32768 - 0x300);
    dst_base_addr2 = (uint32_t *)(0x8000000 + 32768 - 0x200);
    src_base_addr2 = (uint32_t *)(0x8000000 + 32768 - 0x100);
