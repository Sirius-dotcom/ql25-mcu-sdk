...
void main(void)
{
    ...
    Spi_NorFlash_Enter4ByteMode(QSPI2);
    Spi_NorFlash_Erase_Sector(QSPI2, FLASH_ADDR);
    Spi_NorFlash_Write_Page(QSPI2, FLASH_PageProgram, write_buf, FLASH_ADDR, FLASH_PAGESIZE);
    Spi_NorFlash_Read(QSPI2, FLASH_FastReadData, read_buf, FLASH_ADDR, FLASH_PAGESIZE);
    Spi_NorFlash_Exit4ByteMode(QSPI2);
