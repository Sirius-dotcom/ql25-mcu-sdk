...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for EWR TIMING: addr=0x10040028*/
    /*
    field_name: presc                    field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10040028,0xa);

    /*testing for  TXDATA: addr=0x10040030*/
    /*
    field_name: reserved                 field_range: 31:8             field_access: ro  
    field_name: txdata                   field_range: 7:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x10040030,0x0);

    /*testing for  INT_IE: addr=0x10040038*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10040038,0x0);

    /*testing for  SLAVE_ADDRESS1: addr=0x1004003c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1004003c,0x800ffc00);

    /*testing for  SLAVE_ADDRESS2: addr=0x10040044*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10040044,0xffc00);

    /*testing for  TIME_OUT: addr=0x10040048*/
    /*
    field_name: reserved                 field_range: 31:16            field_access: ro  
    field_name: num                      field_range: 15:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10040048,0xffff);

    /*testing for  TXFIFO_WM: addr=0x1004007c*/
    /*
    field_name: reserved                 field_range: 31:4             field_access: ro  
    field_name: wm_cnt                   field_range: 3:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x1004007c,0x0);

    /*testing for  RXFIFO_WM: addr=0x10040080*/
    /*
    field_name: reserved                 field_range: 31:4             field_access: ro  
    field_name: wm_cnt                   field_range: 3:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x10040080,0x0);

    /*testing for RO DEBUG: addr=0x10040098*/
    /*
    field_name: reserved                 field_range: 31:15            field_access: ro  
    field_name: status                   field_range: 14:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x10040098,0x3);

    /*testing for RO IP_VERSION: addr=0x1004009c*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x1004009c,0x30003);

    /*testing for EWR START_SETUP_TIME: addr=0x100400a0*/
    /*
    field_name: start_setup_time         field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400a0,0x32);

    /*testing for EWR START_HOLD_TIME: addr=0x100400a4*/
    /*
    field_name: start_hold_time          field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400a4,0x32);

    /*testing for EWR SDA_SETUP_TIME: addr=0x100400a8*/
    /*
    field_name: sda_setup_time           field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400a8,0x5);

    /*testing for EWR SDA_HOLD_TIME: addr=0x100400ac*/
    /*
    field_name: sda_hold_time            field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400ac,0x4);

    /*testing for EWR SCL_HIGH_PERIOD: addr=0x100400b0*/
    /*
    field_name: scl_high_period          field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400b0,0x32);

    /*testing for EWR SCL_LOW_PERIOD: addr=0x100400b4*/
    /*
    field_name: scl_low_period           field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400b4,0x32);

    /*testing for EWR STOP_SETUP_TIME: addr=0x100400b8*/
    /*
    field_name: stop_setup_time          field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400b8,0x32);

    /*testing for EWR BUS_FREE_TIME: addr=0x100400bc*/
    /*
    field_name: bus_free_time            field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100400bc,0x32);
    ...
    field_name: presc                    field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10040028, 0xa);
    ...
    field_name: txdata                   field_range: 7:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10040030, 0x0, (0x00000000 & 0xff | 0), 0x0, 0xff);

    REG_PWR_Double_Check(0x10040030, 0x0, (0xFFFFFFFF & 0xff | 0), 0xff, 0xff);

    REG_PWR_Double_Check(0x10040030, 0x0, (0x55555555 & 0xff | 0), 0x55, 0xff);

    REG_PWR_Double_Check(0x10040030, 0x0, (0xAAAAAAAA & 0xff | 0), 0xaa, 0xff);
    ...
    field_name: eot_int_ie               field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10040038, 0x0, (0x00000000 & 0x77f | 0), 0x0, 0x77f);

    REG_PWR_Double_Check(0x10040038, 0x0, (0xFFFFFFFF & 0x77f | 0), 0x77f, 0x77f);

    REG_PWR_Double_Check(0x10040038, 0x0, (0x55555555 & 0x77f | 0), 0x555, 0x77f);

    REG_PWR_Double_Check(0x10040038, 0x0, (0xAAAAAAAA & 0x77f | 0), 0x22a, 0x77f);
    ...
    field_name: slave_address1           field_range: 9:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1004003c, 0x800ffc00, (0x00000000 & 0x800fffff | 0), 0x0, 0x800fffff);

    REG_PWR_Double_Check(0x1004003c, 0x800ffc00, (0xFFFFFFFF & 0x800fffff | 0), 0x800fffff, 0x800fffff);

    REG_PWR_Double_Check(0x1004003c, 0x800ffc00, (0x55555555 & 0x800fffff | 0), 0x55555, 0x800fffff);

    REG_PWR_Double_Check(0x1004003c, 0x800ffc00, (0xAAAAAAAA & 0x800fffff | 0), 0x800aaaaa, 0x800fffff);
    ...
    field_name: slave_address2           field_range: 9:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10040044, 0xffc00, (0x00000000 & 0x800fffff | 0), 0x0, 0x800fffff);

    REG_PWR_Double_Check(0x10040044, 0xffc00, (0xFFFFFFFF & 0x800fffff | 0), 0x800fffff, 0x800fffff);

    REG_PWR_Double_Check(0x10040044, 0xffc00, (0x55555555 & 0x800fffff | 0), 0x55555, 0x800fffff);

    REG_PWR_Double_Check(0x10040044, 0xffc00, (0xAAAAAAAA & 0x800fffff | 0), 0x800aaaaa, 0x800fffff);
    ...
    field_name: num                      field_range: 15:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x10040048, 0xffff, (0x00000000 & 0xffff | 0), 0x0, 0xffff);

    REG_PWR_Double_Check(0x10040048, 0xffff, (0xFFFFFFFF & 0xffff | 0), 0xffff, 0xffff);

    REG_PWR_Double_Check(0x10040048, 0xffff, (0x55555555 & 0xffff | 0), 0x5555, 0xffff);

    REG_PWR_Double_Check(0x10040048, 0xffff, (0xAAAAAAAA & 0xffff | 0), 0xaaaa, 0xffff);
    ...
    field_name: wm_cnt                   field_range: 3:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1004007c, 0x0, (0x00000000 & 0xf | 0), 0x0, 0xf);

    REG_PWR_Double_Check(0x1004007c, 0x0, (0xFFFFFFFF & 0xf | 0), 0xf, 0xf);

    REG_PWR_Double_Check(0x1004007c, 0x0, (0x55555555 & 0xf | 0), 0x5, 0xf);

    REG_PWR_Double_Check(0x1004007c, 0x0, (0xAAAAAAAA & 0xf | 0), 0xa, 0xf);
    ...
    field_name: wm_cnt                   field_range: 3:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10040080, 0x0, (0x00000000 & 0xf | 0), 0x0, 0xf);

    REG_PWR_Double_Check(0x10040080, 0x0, (0xFFFFFFFF & 0xf | 0), 0xf, 0xf);

    REG_PWR_Double_Check(0x10040080, 0x0, (0x55555555 & 0xf | 0), 0x5, 0xf);

    REG_PWR_Double_Check(0x10040080, 0x0, (0xAAAAAAAA & 0xf | 0), 0xa, 0xf);
    ...
    field_name: status                   field_range: 14:0             field_access: ro  
    */
    REG_RO_Double_Check(0x10040098, 0x3, 0xFFFFFFFF);

    /*testing for RO IP_VERSION: addr=0x1004009c*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x1004009c, 0x30003, 0xFFFFFFFF);

    /*testing for EWR START_SETUP_TIME: addr=0x100400a0*/
    /*
    field_name: start_setup_time         field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400a0, 0x32);

    /*testing for EWR START_HOLD_TIME: addr=0x100400a4*/
    /*
    field_name: start_hold_time          field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400a4, 0x32);

    /*testing for EWR SDA_SETUP_TIME: addr=0x100400a8*/
    /*
    field_name: sda_setup_time           field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400a8, 0x5);

    /*testing for EWR SDA_HOLD_TIME: addr=0x100400ac*/
    /*
    field_name: sda_hold_time            field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400ac, 0x4);

    /*testing for EWR SCL_HIGH_PERIOD: addr=0x100400b0*/
    /*
    field_name: scl_high_period          field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400b0, 0x32);

    /*testing for EWR SCL_LOW_PERIOD: addr=0x100400b4*/
    /*
    field_name: scl_low_period           field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400b4, 0x32);

    /*testing for EWR STOP_SETUP_TIME: addr=0x100400b8*/
    /*
    field_name: stop_setup_time          field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400b8, 0x32);

    /*testing for EWR BUS_FREE_TIME: addr=0x100400bc*/
    /*
    field_name: bus_free_time            field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100400bc, 0x32);
    ...
    */
    ...
    field_name: status                   field_range: 14:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x10040098);

    /*testing for RO IP_VERSION: addr=0x1004009c*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x1004009c);

    /*testing for EWR START_SETUP_TIME: addr=0x100400a0*/
    /*
    field_name: start_setup_time         field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400a0);

    /*testing for EWR START_HOLD_TIME: addr=0x100400a4*/
    /*
    field_name: start_hold_time          field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400a4);

    /*testing for EWR SDA_SETUP_TIME: addr=0x100400a8*/
    /*
    field_name: sda_setup_time           field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400a8);

    /*testing for EWR SDA_HOLD_TIME: addr=0x100400ac*/
    /*
    field_name: sda_hold_time            field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400ac);

    /*testing for EWR SCL_HIGH_PERIOD: addr=0x100400b0*/
    /*
    field_name: scl_high_period          field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400b0);

    /*testing for EWR SCL_LOW_PERIOD: addr=0x100400b4*/
    /*
    field_name: scl_low_period           field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400b4);

    /*testing for EWR STOP_SETUP_TIME: addr=0x100400b8*/
    /*
    field_name: stop_setup_time          field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400b8);

    /*testing for EWR BUS_FREE_TIME: addr=0x100400bc*/
    /*
    field_name: bus_free_time            field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100400bc);
