...
void main(void)
{
    ...
    I2C_MasterRecvSlaveSend_Onebyone(I2C1, I3, I3_SLAVE_ADDRESS1, i2c_slv_send, i2c_mst_recv, BUFSIZE);

    I2C_MasterSendSlaveRecv_Onebyone(I2C1, I3, I3_SLAVE_ADDRESS1, i2c_mst_send, i2c_slv_recv, BUFSIZE);
