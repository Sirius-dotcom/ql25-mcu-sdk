...
#define I2C0_SLAVE_ADDRESS1 (0x62)
#define I2C0_SLAVE_ADDRESS2 (0x72)
#define BUFSIZE 12
...
void I2C_Config(void)
{
    ...
    init.slave_info1.slave_addr = I2C0_SLAVE_ADDRESS1;
...
void I2C0_IRQHandler(void)
{
    ...
    {
        I2C_Interrupt_En(I2C0, I2C_INT_IE_ARBITRATION_LOST_ENABLE, DISABLE);
        I2C_Clear_Status(I2C0,I2C_STATUS_ARB_LOST);
        if ((I2C0->SETUP & I2C_SETUP_ROLE_MODE) == I2C_SETUP_ROLE_MODE_SLAVE) arb_flag = SUCCESS;
    }
}
...
void main(void)
{
    ...
    I2C_Interrupt_En(I2C0, I2C_INT_IE_ARBITRATION_LOST_ENABLE, ENABLE);
    ...
    I2C_MasterSendSlaveRecv_Onebyone(I3, I2C0, I2C0_SLAVE_ADDRESS1, i2c_mst_send, i2c_slv_recv, BUFSIZE);
