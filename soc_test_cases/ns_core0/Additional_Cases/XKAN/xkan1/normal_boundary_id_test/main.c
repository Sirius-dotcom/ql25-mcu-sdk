...
void xkan_config(void)
{
    ...
    xkan_parameter_init.ram_info.TxBuffersNbr = 2;
    xkan_parameter_init.ram_info.TxFifoElmtsNbr = 2;
    ...
    xKan_RXFilter.FilterID1 = 0x000;
    xKan_RXFilter.FilterID2 = 0x001;
    ...
    xKan_RXFilter.FilterID1 = 0x00000000;
    ...
    xKan_RXFilter.FilterType = XKAN_FILTER_MASK;
    xKan_RXFilter.FilterConfig = XKAN_FILTER_TO_RXBUFFER;
    xKan_RXFilter.FilterID1 = 0x1FFFFFFF;
    xKan_RXFilter.FilterID2 = 0x1FFFFFFF;
    ...
    */
    ...
    xKan_ConfigRxFifoWatermark(XKAN2, XKAN_CFG_RX_FIFO1, 0);
}
...
void xKan_SendPacket(uint8_t *_DataBuf, uint32_t _Len)
{
    ...
    xKan_TxHeader.Identifier = 0x7FF;
    xKan_TxHeader.IdType = XKAN_STANDARD_ID;
    _DataBuf = tmp_msg2;
    ...
    xKan_TxHeader.Identifier = 0x00000000;
    ...
    xKan_TxHeader.Identifier = 0x1FFFFFFF;
    xKan_TxHeader.IdType = XKAN_EXTENDED_ID;
    _DataBuf = tmp_msg3;
    xKan_AddMessageToTxFifo(&xkan_parameter_init, XKAN1, &xKan_TxHeader, _DataBuf, XKAN1_RAM_BASE);
}
...
void XKAN2_IRQHandler(void)
{
    ...
    if(xKan_GetInterruptStatus(XKAN2, XKAN_CFG_INT_STATUS_RXB_UPD_INT) && xKan_GetInterruptEnable(XKAN2, XKAN_CFG_INT_EN_RXB_UPD_EN))
    {
        ...
        rx_buf_done ++;
        pRxData += BUFSIZE;
        if (rx_buf_done == 2) xKan_EnableInterrupt(XKAN2, XKAN_CFG_INT_EN_RXB_UPD_EN, DISABLE);
    }
}
...
void main(void)
{
    ...
    while(!rxfifo1_done || !rxfifo0_done || rx_buf_done != 2){}
