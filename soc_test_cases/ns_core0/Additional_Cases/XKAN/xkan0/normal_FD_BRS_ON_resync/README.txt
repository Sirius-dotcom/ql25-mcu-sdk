...
Function description:
    This demo shows the {per_inst} communication with {per1_inst} through CANFD data frame protocol in normal mode with BRS on with different sample point, which will
cause resync, and then compares the consistency of the sent and received data.
