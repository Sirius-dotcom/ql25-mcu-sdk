...
void xkan0_config(void)
{
    ...
    /* step2.1: nominal bit timing config(sample-point:81.25%) */
    xkan_parameter_init.normal_time.NominalPrescaler = 0x4;
    xkan_parameter_init.normal_time.NominalSyncJumpWidth = 2;
    xkan_parameter_init.normal_time.NominalTimeSeg1 = 12;
    xkan_parameter_init.normal_time.NominalTimeSeg2 = 3;

    /* step2.2: data bit timing config(sample-point:81.25%) */
    xkan_parameter_init.data_time.DataPrescaler = 2;
    xkan_parameter_init.data_time.DataSyncJumpWidth = 2;
    xkan_parameter_init.data_time.DataTimeSeg1 = 12;
    xkan_parameter_init.data_time.DataTimeSeg2 = 3;
...
void xkan1_config(void)
{
    ...
    xkan_parameter_init.normal_time.NominalPrescaler = 4;
    xkan_parameter_init.normal_time.NominalSyncJumpWidth = 3;
    xkan_parameter_init.normal_time.NominalTimeSeg1 = 11;
    xkan_parameter_init.normal_time.NominalTimeSeg2 = 4;

    /* step2.2: data bit timing config(sample-point:75%) */
    xkan_parameter_init.data_time.DataPrescaler = 2;
    xkan_parameter_init.data_time.DataSyncJumpWidth = 3;
    xkan_parameter_init.data_time.DataTimeSeg1 = 11;
    xkan_parameter_init.data_time.DataTimeSeg2 = 4;
...
void main(void)
{
    ...
    printf("xkan normal_FD_BRS_ON test\n\r");
    /* xkan cfg */ 
    xkan0_config();
    xkan1_config();
    /* config int handle */
