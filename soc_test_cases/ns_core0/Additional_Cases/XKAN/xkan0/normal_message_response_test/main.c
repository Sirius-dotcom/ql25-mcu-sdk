...
void xkan_config(void)
{
    ...
    xkan_parameter_init.ram_info.RxBuffersNbr = 64;
    ...
    xKan_RXFilter.RxBufferIndex = 32;
    ...
    xKan_RXFilter.FilterID2 = 0x7FF;
    xKan_RXFilter.RxBufferIndex = 33;
    xKan_ConfigFilter(XKAN0, &xkan_parameter_init, &xKan_RXFilter, XKAN0_RAM_BASE);
    xKan_ConfigFilter(XKAN1, &xkan_parameter_init, &xKan_RXFilter, XKAN1_RAM_BASE);
    ...
    xKan_RXFilter.RxBufferIndex = 62;
    xKan_ConfigFilter(XKAN0, &xkan_parameter_init, &xKan_RXFilter, XKAN0_RAM_BASE);
    xKan_ConfigFilter(XKAN1, &xkan_parameter_init, &xKan_RXFilter, XKAN1_RAM_BASE);
    ...
    xKan_RXFilter.FilterID2 = 0x1FFFFFFF;
    xKan_RXFilter.RxBufferIndex = 63;
    xKan_ConfigFilter(XKAN0, &xkan_parameter_init, &xKan_RXFilter, XKAN0_RAM_BASE);
    xKan_ConfigFilter(XKAN1, &xkan_parameter_init, &xKan_RXFilter, XKAN1_RAM_BASE);
...
void xKan_SendPacket(uint8_t *_DataBuf, uint32_t _Len)
{
    ...
    _DataBuf = tmp_msg2;
    XKAN_AddMessageToTxBuffer(&xkan_parameter_init, XKAN0, &xKan_TxHeader, _DataBuf, XKAN_TX_BUFFER30, XKAN0_RAM_BASE);

    xKan_TxHeader.Identifier = 0x12345679;
    xKan_TxHeader.IdType = XKAN_EXTENDED_ID;
    _DataBuf = tmp_msg3;
    XKAN_AddMessageToTxBuffer(&xkan_parameter_init, XKAN0, &xKan_TxHeader, _DataBuf, XKAN_TX_BUFFER31, XKAN0_RAM_BASE);

    xKan_EnableTxBufferRequest(XKAN0, XKAN_TX_BUFFER0|XKAN_TX_BUFFER1|XKAN_TX_BUFFER30|XKAN_TX_BUFFER31);
}
...
void main(void)
{
    ...
    printf("xkan normal_message_response_test\n\r");
    /* xkan cfg */ 
    xkan_config();
