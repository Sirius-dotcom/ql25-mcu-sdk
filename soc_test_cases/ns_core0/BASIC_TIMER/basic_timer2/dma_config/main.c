...
int main(void)
{
    ...
    UDMA_PAM2MStruct.UDMA_DstBaseAddr = CAL_ADDR_LO(BASIC_TIMER2 + 0x2C);
    ...
    UDMA_PAM2MStruct.UDMA_PER_SEL = UDMA_SEL_BASIC_TIMER2_I;
    UDMA_PAM2M_Init(BASIC_TIMER2_I_DMA_CH, &UDMA_PAM2MStruct);
    ...
    Basic_Timer_DmaEnable(BASIC_TIMER2, BASIC_TIMER_DIER_UDE);
