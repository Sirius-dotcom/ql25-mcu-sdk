...
void BASIC_TIMER0_IRQHandler(void)
{
    ...
    if(SET == Basic_Timer_InterruptFlagGet(BASIC_TIMER0, BASIC_TIMER_DIER_UIE)) {
        ...
        {
            state = 0;
            Basic_Timer_Disable(BASIC_TIMER0);
        }
    }
}
...
int main(void)
{
    ...
    UDMA_PAM2MStruct.UDMA_DstBaseAddr = CAL_ADDR_LO(BASIC_TIMER0 + 0x2C);
    ...
    UDMA_PAM2MStruct.UDMA_PER_SEL = UDMA_SEL_BASIC_TIMER0_I;
    UDMA_PAM2M_Init(BASIC_TIMER0_I_DMA_CH, &UDMA_PAM2MStruct);
    ...
    Basic_Timer_DmaEnable(BASIC_TIMER0, BASIC_TIMER_DIER_UDE);
