...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for  CR1: addr=0x100e0000*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x100e0000,0x0);

    /*testing for  CR2: addr=0x100e0004*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x100e0004,0x0);

    /*testing for  DIER: addr=0x100e000c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x100e000c,0x0);

    /*testing for  EGR: addr=0x100e0014*/
    /*
    field_name: reserved                 field_range: 31:1             field_access: ro  
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_DefVal_CHECK(0x100e0014,0x0);

    /*testing for EWR CNT: addr=0x100e0024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100e0024,0x0);

    /*testing for  PSC: addr=0x100e0028*/
    /*
    field_name: reserved                 field_range: 31:16            field_access: ro  
    field_name: psc                      field_range: 15:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100e0028,0x0);

    /*testing for EWR ARR: addr=0x100e002c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100e002c,0xffffffff);

    /*testing for RO IP_VERSION: addr=0x100e0030*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x100e0030,0x10202);
    ...
    field_name: cen                      field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x100e0000, 0x0, (0x00000000 & 0x8f | 0), 0x0, 0x8f);

    REG_PWR_Double_Check(0x100e0000, 0x0, (0xFFFFFFFF & 0x8f | 0), 0x8f, 0x8f);

    REG_PWR_Double_Check(0x100e0000, 0x0, (0x55555555 & 0x8f | 0), 0x5, 0x8f);

    REG_PWR_Double_Check(0x100e0000, 0x0, (0xAAAAAAAA & 0x8f | 0), 0x8a, 0x8f);
    ...
    field_name: reserved                 field_range: 3:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x100e0004, 0x0, (0x00000000 & 0x70 | 0), 0x0, 0x70);

    REG_PWR_Double_Check(0x100e0004, 0x0, (0xFFFFFFFF & 0x70 | 0), 0x70, 0x70);

    REG_PWR_Double_Check(0x100e0004, 0x0, (0x55555555 & 0x70 | 0), 0x50, 0x70);

    REG_PWR_Double_Check(0x100e0004, 0x0, (0xAAAAAAAA & 0x70 | 0), 0x20, 0x70);
    ...
    field_name: uie                      field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x100e000c, 0x0, (0x00000000 & 0x101 | 0), 0x0, 0x101);

    REG_PWR_Double_Check(0x100e000c, 0x0, (0xFFFFFFFF & 0x101 | 0), 0x101, 0x101);

    REG_PWR_Double_Check(0x100e000c, 0x0, (0x55555555 & 0x101 | 0), 0x101, 0x101);

    REG_PWR_Double_Check(0x100e000c, 0x0, (0xAAAAAAAA & 0x101 | 0), 0x0, 0x101);
    ...
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_PWR_Double_Check(0x100e0014, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x100e0014, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x100e0014, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x100e0014, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);

    /*testing for EWR CNT: addr=0x100e0024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100e0024, 0x0);
    ...
    field_name: psc                      field_range: 15:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x100e0028, 0x0, (0x00000000 & 0xffff | 0), 0x0, 0xffff);

    REG_PWR_Double_Check(0x100e0028, 0x0, (0xFFFFFFFF & 0xffff | 0), 0xffff, 0xffff);

    REG_PWR_Double_Check(0x100e0028, 0x0, (0x55555555 & 0xffff | 0), 0x5555, 0xffff);

    REG_PWR_Double_Check(0x100e0028, 0x0, (0xAAAAAAAA & 0xffff | 0), 0xaaaa, 0xffff);

    /*testing for EWR ARR: addr=0x100e002c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100e002c, 0xffffffff);

    /*testing for RO IP_VERSION: addr=0x100e0030*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x100e0030, 0x10202, 0xFFFFFFFF);
    ...
    */
    ...
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_CLK_DIS_CHECK(0x100e0014);

    /*testing for EWR CNT: addr=0x100e0024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100e0024);
    ...
    field_name: psc                      field_range: 15:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100e0028);

    /*testing for EWR ARR: addr=0x100e002c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100e002c);

    /*testing for RO IP_VERSION: addr=0x100e0030*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x100e0030);
