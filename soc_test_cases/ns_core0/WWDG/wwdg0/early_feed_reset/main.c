...
#define POR_FLAG ~(RESET_CTRL_WWDG0_WDOGRES | RESET_CTRL_BROM_CPU_RST_N_O)
#else
...
int main(void)
{
    ...
    wwdg_config(WWDG0,0x3fffff, 80, WWDG_CFR_WDGTB_DIV_1);
    delay_1ms(1);
    wwdg_counter_update(WWDG0,0x3fffff);
    #else
    wwdg_config(WWDG0,0x3fffff, 80, WWDG_CFR_WDGTB_DIV_1);
    #endif
