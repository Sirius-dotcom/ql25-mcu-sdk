...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for RO VER: addr=0x100c000c*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x100c000c,0x10301);
    ...
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x100c000c, 0x10301, 0xFFFFFFFF);
    ...
    */
    ...
    wwdg0_clk_en(DISABLE);

    /*testing for RO VER: addr=0x100c000c*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x100c000c);
