...
void TIMER_Config(void)
{
    ...
    Timer_CKDIV(ADVANCED_TIMER1, ADV_TIMER_TIM_CR1_CKD_CKD2);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_1, 500);
    ...
    Timer_BreakConfig(ADVANCED_TIMER1, &timer_breakpara);
