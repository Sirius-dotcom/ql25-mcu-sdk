...
void iomux_config(void)
{
    ...
    iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER1_TIM_CH2_IOF_IVAL,ADVANCED_TIMER1_TIM_CH2_PAD_SEL,ADVANCED_TIMER1_TIM_CH2_HS_SEL,0,0);
...
void ADVANCED_TIMER1_IRQHandler(void)
{
    ...
    if(Timer_FlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC1IF) == SET)
    {
     
        if(cnt_buf==1){
            if(Timer_FlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC1OF) == SET)
            {
                cnt_buf2 = 1;
                Timer_InterruptDisable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE); 
                Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC1IF);
                Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC1OF);
            }
        }else{
            Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC1IF);
            cnt_buf = 1;
    ...
    else if(Timer_FlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC2IF) == SET)
    { 
        if(cnt_buf1==1){
            if(Timer_FlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC2OF) == SET)
            {
                cnt_buf3 = 1;
                Timer_InterruptDisable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC2IE); 
                Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC2IF);
                Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC2OF);
            }
        }else{
            Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_CC2IF);
            cnt_buf1 = 1;
...
void TIMER_Config(void)
{
    ...
    Timer_InputTriggerSourceSelect(ADVANCED_TIMER1,ADV_TIMER_TIM_SMCR_TS_TI1F_ED);
    ...
    Timer_InterruptEnable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE);  
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_1, 12000);
    /*****************************************************/
    ...
    Timer_InputCaptureConfig(ADVANCED_TIMER1, TIMER_CH_2, &timer_icinitpara);
    Timer_InterruptEnable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC2IE); 
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_2, 12000); 
    /*****************************************************/
