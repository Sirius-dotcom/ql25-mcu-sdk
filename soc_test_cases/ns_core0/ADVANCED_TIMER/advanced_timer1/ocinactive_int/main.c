...
/**
  * \brief This function handles ADVANCED_TIMER1 interrupt request.
  */
void ADVANCED_TIMER1_IRQHandler(void)
{
    if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE_ENABLE)) {
        
        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE_ENABLE);
        state++;
    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC2IE_ENABLE)) {

        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC2IE_ENABLE);
        state++;

    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC3IE_ENABLE)) {

        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC3IE_ENABLE);
        state++;
    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC4IE_ENABLE)) {

        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC4IE_ENABLE);
        state++;

    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_UIE_ENABLE)) {

        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_UIE_ENABLE);
        state++;
...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputConfig(ADVANCED_TIMER1, TIMER_CH_4, &timer_ocinitpara);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_1,4000);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER1, TIMER_CH_1, ADV_TIMER_TIM_CCMR1_OC1M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER1, TIMER_CH_1, ADV_TIMER_TIM_CCMR1_OC1PE_DISABLE);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_2,8000);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER1, TIMER_CH_2, ADV_TIMER_TIM_CCMR1_OC2M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER1, TIMER_CH_2, ADV_TIMER_TIM_CCMR1_OC2PE_DISABLE);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_3,12000);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER1, TIMER_CH_3, ADV_TIMER_TIM_CCMR2_OC3M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER1, TIMER_CH_3, ADV_TIMER_TIM_CCMR2_OC3PE_DISABLE);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_4,12000);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER1, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER1, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4PE_DISABLE);

    Timer_InterruptEnable(ADVANCED_TIMER1, (ADV_TIMER_TIM_DIER_CC1IE | ADV_TIMER_TIM_DIER_CC2IE | ADV_TIMER_TIM_DIER_CC3IE | ADV_TIMER_TIM_DIER_CC4IE |ADV_TIMER_TIM_DIER_UIE));
...
void main(void)
{
    ...
    __enable_irq();
    ECLIC_Register_IRQ(ADVANCED_TIMER1_IRQn, ECLIC_NON_VECTOR_INTERRUPT,
                                    ECLIC_LEVEL_TRIGGER, 1, 0,
                                    ADVANCED_TIMER1_IRQHandler);
    TIMER_Config();
