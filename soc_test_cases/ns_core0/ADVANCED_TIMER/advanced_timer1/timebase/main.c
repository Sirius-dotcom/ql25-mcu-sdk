...
{
    if( SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE)) {
        /* clear channel 0 interrupt bit */
        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE);
        status = 1;
    }
}
...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER1, TIMER_CH_1, ADV_TIMER_TIM_CCMR1_OC1M_FROZEN);
