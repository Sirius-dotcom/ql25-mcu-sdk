...
void TIMER_Config(void)
{
    ...
    Timer_InputTriggerSourceSelect(ADVANCED_TIMER0, ADV_TIMER_TIM_SMCR_TS_ETRF);

    Timer_ExternalClockMode1Config(ADVANCED_TIMER0, ADV_TIMER_TIM_SMCR_ETP_DISABLE,ADV_TIMER_TIM_SMCR_ETPS_PRESCALER,ADV_TIMER_TIM_SMCR_ETF_NO_FILTER);
...
{
    iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER0_TIM_ETR_0_IOF_IVAL,ADVANCED_TIMER0_TIM_ETR_0_PAD_SEL,ADVANCED_TIMER0_TIM_ETR_0_HS_SEL,0,0);
