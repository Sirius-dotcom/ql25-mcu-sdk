...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_2, 500);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER0, TIMER_CH_2, ADV_TIMER_TIM_CCMR1_OC2M_PWM2);
    ...
    Timer_SinglePulseModeConfig(ADVANCED_TIMER0, ADV_TIMER_TIM_CR1_OPM_ENABLE);
