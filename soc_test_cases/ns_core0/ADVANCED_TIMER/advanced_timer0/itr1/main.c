...
void TIMER_Config(void)
{
    ...
    Timer_MasterSlaveModeConfig(ADVANCED_TIMER0,ADV_TIMER_TIM_SMCR_MSM_ENABLE);
    Timer_RepetitionValueConfig(ADVANCED_TIMER0,ADV_TIMER_TIM_RCR_REP(5) );
    Timer_MasterOutputTriggerSourceSelect(ADVANCED_TIMER0, ADV_TIMER_TIM_CR2_MMS_TRIGGER_OUTPUT);
