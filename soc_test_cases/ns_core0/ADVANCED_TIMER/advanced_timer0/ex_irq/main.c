...
void ADVANCED_TIMER0_IRQHandler(void)
{
    ...
    if(Timer_FlagGet(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC1IF) == SET)
    {
     
        if(cnt_buf==1){
            if(Timer_FlagGet(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC1OF) == SET)
            {
                cnt_buf2 = 1;
                Timer_InterruptDisable(ADVANCED_TIMER0, ADV_TIMER_TIM_DIER_CC1IE); 
                Timer_InterruptFlagClear(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC1IF);
                Timer_InterruptFlagClear(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC1OF);
            }
        }else{
            Timer_InterruptFlagClear(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC1IF);
            cnt_buf = 1;
    ...
    else if(Timer_FlagGet(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC2IF) == SET)
    { 
        if(cnt_buf1==1){
            if(Timer_FlagGet(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC2OF) == SET)
            {
                cnt_buf3 = 1;
                Timer_InterruptDisable(ADVANCED_TIMER0, ADV_TIMER_TIM_DIER_CC2IE); 
                Timer_InterruptFlagClear(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC2IF);
                Timer_InterruptFlagClear(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC2OF);
            }
        }else{
            Timer_InterruptFlagClear(ADVANCED_TIMER0, ADV_TIMER_TIM_SR_CC2IF);
            cnt_buf1 = 1;
...
void TIMER_Config(void)
{
    ...
    Timer_InterruptEnable(ADVANCED_TIMER0, ADV_TIMER_TIM_DIER_CC1IE);  
    ...
    Timer_InterruptEnable(ADVANCED_TIMER0, ADV_TIMER_TIM_DIER_CC2IE); 
