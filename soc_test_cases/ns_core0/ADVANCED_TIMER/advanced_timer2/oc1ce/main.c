...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER2, TIMER_CH_1, 40);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER2, TIMER_CH_2, 80);
    ...
    Timer_InputTriggerSourceSelect(ADVANCED_TIMER2, ADV_TIMER_TIM_SMCR_TS_ETRF);
...
{
  iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER2_TIM_ETR_0_IOF_IVAL,ADVANCED_TIMER2_TIM_ETR_0_PAD_SEL,ADVANCED_TIMER2_TIM_ETR_0_HS_SEL,0,0);
...
void main(void)
{
    ...
    TIMER_Config();
    delay_1ms(2);
    Timer_ChannelOutputClearConfig(ADVANCED_TIMER2,TIMER_CH_1,ADV_TIMER_TIM_CCMR1_OC1CE_ENABLE);
    delay_1ms(2);
    simulation_check();
