...
/**
  * \brief This function handles ADVANCED_TIMER2 interrupt request.
  */
void ADVANCED_TIMER2_IRQHandler(void)
{
    if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC1IE_ENABLE)) {

        Timer_InterruptDisable(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC1IE_ENABLE );
        Timer_InterruptFlagClear(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC1IE_ENABLE);
        state0=1;
    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC2IE_ENABLE)) {

        Timer_InterruptDisable(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC1IE_ENABLE );
        Timer_InterruptFlagClear(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC2IE_ENABLE);
        state1=1;

    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC3IE_ENABLE)) {

        Timer_InterruptDisable(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC3IE_ENABLE );
        Timer_InterruptFlagClear(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC3IE_ENABLE);
        state2=1;
    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC4IE_ENABLE)) {

        Timer_InterruptDisable(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC4IE_ENABLE );
        Timer_InterruptFlagClear(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_CC4IE_ENABLE);
        state3=1;
...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputConfig(ADVANCED_TIMER2, TIMER_CH_4, &timer_ocinitpara);
    ...
    Timer_CounterAlignment(ADVANCED_TIMER2, ADV_TIMER_TIM_CR1_CMS_CENTER_ALIGNED3);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER2,TIMER_CH_1,200);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER2,TIMER_CH_2,400);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER2, TIMER_CH_2, ADV_TIMER_TIM_CCMR1_OC2M_PWM1);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER2, TIMER_CH_2, ADV_TIMER_TIM_CCMR1_OC2PE_DISABLE);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER2,TIMER_CH_3,600);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER2, TIMER_CH_3, ADV_TIMER_TIM_CCMR2_OC3M_PWM1);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER2, TIMER_CH_3, ADV_TIMER_TIM_CCMR2_OC3PE_DISABLE);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER2,TIMER_CH_4,800);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER2, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4M_PWM1);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER2, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4PE_DISABLE);

    Timer_InterruptEnable(ADVANCED_TIMER2, (ADV_TIMER_TIM_DIER_CC1IE | ADV_TIMER_TIM_DIER_CC2IE | ADV_TIMER_TIM_DIER_CC3IE | ADV_TIMER_TIM_DIER_CC4IE ));
...
void main(void)
{
    ...
    __enable_irq();
    ECLIC_Register_IRQ(ADVANCED_TIMER2_IRQn, ECLIC_NON_VECTOR_INTERRUPT,
                                    ECLIC_LEVEL_TRIGGER, 1, 0,
                                    ADVANCED_TIMER2_IRQHandler);
    TIMER_Config();
