...
void ADVANCED_TIMER2_IRQHandler(void)
{
    ...
    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_UIE_ENABLE)) {

        Timer_InterruptFlagClear(ADVANCED_TIMER2, ADV_TIMER_TIM_DIER_UIE_ENABLE);
        state++;
...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER2, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER2, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4PE_DISABLE);

    Timer_InterruptEnable(ADVANCED_TIMER2, (ADV_TIMER_TIM_DIER_CC1IE | ADV_TIMER_TIM_DIER_CC2IE | ADV_TIMER_TIM_DIER_CC3IE | ADV_TIMER_TIM_DIER_CC4IE |ADV_TIMER_TIM_DIER_UIE));
