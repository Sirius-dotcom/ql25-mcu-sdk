...
void TIMER_Config(void)
{
    ...
    Timer_AutoReloadShadowDisable(ADVANCED_TIMER3);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_1, CH1_COUNT);
    ...
    /* ADVANCED_TIMER3 CH0 input capture configuration */
    ...
    Timer_InputCaptureConfig(ADVANCED_TIMER3, TIMER_CH_4, &timer_icinitpara);
...
{
    iomux_ls_iof_oval_cfg(IOMUX_BASE,ADVANCED_TIMER3_TIM_CH1N_IOF_OVAL,ADVANCED_TIMER3_TIM_CH1N_PAD_SEL,ADVANCED_TIMER3_TIM_CH1N_HS_SEL,0,0);
    ...
    iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER3_TIM_CH4_IOF_IVAL,ADVANCED_TIMER3_TIM_CH4_PAD_SEL,ADVANCED_TIMER3_TIM_CH4_HS_SEL,0,0);
}
...
void main(void)
{
    ...
    while (times--) {
        count2 = Timer_ChannelCaptureValueRegisterRead(ADVANCED_TIMER3, TIMER_CH_2);
        count4 = Timer_ChannelCaptureValueRegisterRead(ADVANCED_TIMER3, TIMER_CH_4);
