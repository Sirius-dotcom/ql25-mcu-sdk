...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_1, 3999);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_2, 7999);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_3, 11999);
