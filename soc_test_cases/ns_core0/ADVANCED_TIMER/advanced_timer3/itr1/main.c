...
void TIMER_Config(void)
{
    ...
    Timer_MasterSlaveModeConfig(ADVANCED_TIMER3,ADV_TIMER_TIM_SMCR_MSM_ENABLE);
    Timer_RepetitionValueConfig(ADVANCED_TIMER3,ADV_TIMER_TIM_RCR_REP(5) );
    Timer_MasterOutputTriggerSourceSelect(ADVANCED_TIMER3, ADV_TIMER_TIM_CR2_MMS_TRIGGER_OUTPUT);
...
{
    iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER3_TIM_ETR_0_IOF_IVAL,ADVANCED_TIMER3_TIM_ETR_0_PAD_SEL,ADVANCED_TIMER3_TIM_ETR_0_HS_SEL,0,0);
