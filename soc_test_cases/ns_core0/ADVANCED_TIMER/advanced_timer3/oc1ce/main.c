...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_1, 40);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_2, 80);
...
void main(void)
{
    ...
    TIMER_Config();
    delay_1ms(2);
    Timer_ChannelOutputClearConfig(ADVANCED_TIMER3,TIMER_CH_1,ADV_TIMER_TIM_CCMR1_OC1CE_ENABLE);
    delay_1ms(2);
    simulation_check();
