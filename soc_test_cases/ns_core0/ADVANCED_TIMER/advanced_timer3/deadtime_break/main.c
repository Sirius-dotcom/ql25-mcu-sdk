...
void TIMER_Config(void)
{
    ...
    Timer_CKDIV(ADVANCED_TIMER3, ADV_TIMER_TIM_CR1_CKD_CKD2);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3, TIMER_CH_1, 500);
    ...
    Timer_BreakConfig(ADVANCED_TIMER3, &timer_breakpara);
