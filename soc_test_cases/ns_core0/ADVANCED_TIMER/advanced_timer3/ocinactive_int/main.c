...
void ADVANCED_TIMER3_IRQHandler(void)
{
    ...
    } else if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER3, ADV_TIMER_TIM_DIER_UIE_ENABLE)) {

        Timer_InterruptFlagClear(ADVANCED_TIMER3, ADV_TIMER_TIM_DIER_UIE_ENABLE);
        state++;
...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3,TIMER_CH_1,4000);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER3, TIMER_CH_1, ADV_TIMER_TIM_CCMR1_OC1M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER3, TIMER_CH_1, ADV_TIMER_TIM_CCMR1_OC1PE_DISABLE);

    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER3,TIMER_CH_2,8000);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER3, TIMER_CH_2, ADV_TIMER_TIM_CCMR1_OC2M_SET_ACTIVE);
    ...
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER3, TIMER_CH_3, ADV_TIMER_TIM_CCMR2_OC3M_SET_ACTIVE);
    ...
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER3, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4M_SET_ACTIVE);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER3, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4PE_DISABLE);

    Timer_InterruptEnable(ADVANCED_TIMER3, (ADV_TIMER_TIM_DIER_CC1IE | ADV_TIMER_TIM_DIER_CC2IE | ADV_TIMER_TIM_DIER_CC3IE | ADV_TIMER_TIM_DIER_CC4IE |ADV_TIMER_TIM_DIER_UIE));
