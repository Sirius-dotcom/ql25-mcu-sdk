...
#define ARR_SIZE 3    
uint8_t USART1_send_buffer[ARR_SIZE]={0x01,0x02,0x13};
...
{     
        if(USART_GetITStatus(USART2,USART_STATUS_STOP_BIT_ERR_FLAG) == SET)
        {
        USART_ClearITStatus(USART2,USART_STATUS_STOP_BIT_ERR_FLAG);
        error_count++;
