...
uint8_t USART1_send_buffer[ARR_SIZE]={ 0x10 ,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,0x19,0x18,0x17,0x16,0x15,0x14,0x13,0x12,0x11,0x10};
uint8_t USART2_receive_buffer[ARR_SIZE]={0};
uint8_t USART1_receive_buffer[ARR_SIZE]={};
uint8_t USART2_send_buffer[ARR_SIZE]={ 0x10 ,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,0x19,0x18,0x17,0x16,0x15,0x14,0x13,0x12,0x11,0x10};
...
void main(void )
{
    ...
    iomux_config();
    USART_Irda_En(USART1,ENABLE);
    USART_Irda_En(USART2,ENABLE);
