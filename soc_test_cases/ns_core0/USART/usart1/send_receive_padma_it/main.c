...
uint32_t USART1_send_buffer[ARR_SIZE]={ 0x11 ,0x12,0x13,0x14,0x15,0x16,0x17,0x8,0x19,0x1a};
uint32_t USART2_receive_buffer[ARR_SIZE]={ 0};
...
int main(void)
{
    ...
    memcpy((uint8_t *)src_base_addr, (uint8_t *)USART1_send_buffer, ARR_SIZE*4);
    ...
    while(USART_GetFlag(USART1,USART_STATUS_TX_BUSY)==1){};
