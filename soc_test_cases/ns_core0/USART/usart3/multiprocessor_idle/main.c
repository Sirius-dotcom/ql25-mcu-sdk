...
uint8_t USART3_send_buffer[ARR_SIZE]={ 0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18};
...
void main(void )
{
    ...
    USART_WakeUpConfig(USART4,USART_ADVANCED_SETUP_WAKE_MOD_IDLE);

    USART_ReceiverWakeUpCmd(USART4, ENABLE);

    USART_SendData(USART3, USART3_send_buffer[0]);
    USART_SendData(USART3, USART3_send_buffer[1]);
    USART_SendData(USART3, USART3_send_buffer[2]);
    USART_SendData(USART3, USART3_send_buffer[3]);
    USART_SendData(USART3, USART3_send_buffer[4]);
    USART_WriteWakeUp(USART4);
    USART_SendData(USART3, USART3_send_buffer[5]);
    USART_SendData(USART3, USART3_send_buffer[6]);
    ...
    while(USART_READWakeUp(USART4)==USART_ADVANCED_STATUS_RWUFMM){}
