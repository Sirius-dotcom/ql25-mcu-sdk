...
uint16_t USART4_send_buffer[ARR_SIZE]={ 0x1F6 ,0x1F7,0x1F8,0x1F9,0x1FA,0x1FB,0x1FC,0x1FD,0x1FE,0x1FF};
...
void main(void )
{
    ...
    do {
        USART_Send9Bit(USART3, USART3_send_buffer[j]);
        USART4_receive_buffer[j] = USART_Receive9Bit(USART4);
    } while ((++j) < ARR_SIZE);
