...
void main(void)
{
    ...
    UDMA_InitStruct.UDMA_SrcWidth = UDMA_MSWIDTH_16BIT;
    UDMA_InitStruct.UDMA_DstWidth = UDMA_MDWIDTH_16BIT;
    UDMA_InitStruct.UDMA_Mode = UDMA_MODE_NORMAL;
    UDMA_InitStruct.UDMA_BurstBoundary = UDMA_MCTRL_BST_BND_4K;
    UDMA_InitStruct.UDMA_Priority = UDMA_PRIORITY_LOW;

    UDMA_Init(UDMA0_M2M_CH0, &UDMA_InitStruct);

    UDMA_BurstConfig(UDMA0_M2M_CH0, ENABLE, UDMA_MSBURST_16_TRANSFER, UDMA_MDBURST_16_TRANSFER);
