...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for EWR CH0_CFG_MSRCADDR: addr=0x10020008*/
    /*
    field_name: src_base                 field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10020008,0x0);

    /*testing for EWR CH0_CFG_MDSTADDR: addr=0x1002000c*/
    /*
    field_name: dst_base                 field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x1002000c,0x0);

    /*testing for  CH0_CFG_MRPT: addr=0x10020014*/
    /*
    field_name: reserved                 field_range: 31:18            field_access: ro  
    field_name: rpt_daum                 field_range: 17:17            field_access: rw  
    field_name: rpt_saum                 field_range: 16:16            field_access: rw  
    field_name: reserved                 field_range: 15:13            field_access: ro  
    field_name: rpt_irq_en               field_range: 12:12            field_access: rw  
    field_name: trans_rpt                field_range: 11:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10020014,0x0);

    /*testing for  CH0_CFG_MSIZE: addr=0x10020018*/
    /*
    field_name: reserved                 field_range: 31:25            field_access: ro  
    field_name: tsize                    field_range: 24:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10020018,0x0);

    /*testing for EWR CH0_CFG_MRAU: addr=0x10020024*/
    /*
    field_name: rdau                     field_range: 31:16            field_access: rw  
    field_name: rsau                     field_range: 15:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10020024,0x0);

    /*testing for EWR CH0_CFG_MLLA: addr=0x10020028*/
    /*
    field_name: lla                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10020028,0x0);

    /*testing for  CH0_IRQ_EN: addr=0x10020800*/
    /*
    field_name: reserved                 field_range: 31:5             field_access: ro  
    field_name: lla_ftrans_irq_en        field_range: 4:4              field_access: rw  
    field_name: lla_err_irq_en           field_range: 3:3              field_access: rw  
    field_name: rsp_err_irq_en           field_range: 2:2              field_access: rw  
    field_name: htrans_irq_en            field_range: 1:1              field_access: rw  
    field_name: ftrans_irq_en            field_range: 0:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x10020800,0x0);

    /*testing for  CH0_IRQ_STAT: addr=0x10020804*/
    /*
    field_name: reserved                 field_range: 31:5             field_access: ro  
    field_name: lla_ftrans_irq_stat      field_range: 4:4              field_access: r0  
    field_name: lla_err_irq_stat         field_range: 3:3              field_access: r0  
    field_name: rsp_err_irq_stat         field_range: 2:2              field_access: ro  
    field_name: htrans_irq_stat          field_range: 1:1              field_access: ro  
    field_name: ftrans_irq_stat          field_range: 0:0              field_access: ro  
    */
    REG_DefVal_CHECK(0x10020804,0x0);

    /*testing for RO VERSION: addr=0x10020ffc*/
    /*
    field_name: ver                      field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x10020ffc,0x20400);
    ...
    field_name: src_base                 field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10020008, 0x0);

    /*testing for EWR CH0_CFG_MDSTADDR: addr=0x1002000c*/
    /*
    field_name: dst_base                 field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x1002000c, 0x0);
    ...
    field_name: trans_rpt                field_range: 11:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x10020014, 0x0, (0x00000000 & 0x31fff | 0), 0x0, 0x31fff);

    REG_PWR_Double_Check(0x10020014, 0x0, (0xFFFFFFFF & 0x31fff | 0), 0x31fff, 0x31fff);

    REG_PWR_Double_Check(0x10020014, 0x0, (0x55555555 & 0x31fff | 0), 0x11555, 0x31fff);

    REG_PWR_Double_Check(0x10020014, 0x0, (0xAAAAAAAA & 0x31fff | 0), 0x20aaa, 0x31fff);
    ...
    field_name: tsize                    field_range: 24:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x10020018, 0x0, (0x00000000 & 0x1ffffff | 0), 0x0, 0x1ffffff);

    REG_PWR_Double_Check(0x10020018, 0x0, (0xFFFFFFFF & 0x1ffffff | 0), 0x1ffffff, 0x1ffffff);

    REG_PWR_Double_Check(0x10020018, 0x0, (0x55555555 & 0x1ffffff | 0), 0x1555555, 0x1ffffff);

    REG_PWR_Double_Check(0x10020018, 0x0, (0xAAAAAAAA & 0x1ffffff | 0), 0xaaaaaa, 0x1ffffff);
    ...
    field_name: rsau                     field_range: 15:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10020024, 0x0);

    /*testing for EWR CH0_CFG_MLLA: addr=0x10020028*/
    /*
    field_name: lla                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10020028, 0x0);
    ...
    field_name: ftrans_irq_en            field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10020800, 0x0, (0x00000000 & 0x1f | 0), 0x0, 0x1f);

    REG_PWR_Double_Check(0x10020800, 0x0, (0xFFFFFFFF & 0x1f | 0), 0x1f, 0x1f);

    REG_PWR_Double_Check(0x10020800, 0x0, (0x55555555 & 0x1f | 0), 0x15, 0x1f);

    REG_PWR_Double_Check(0x10020800, 0x0, (0xAAAAAAAA & 0x1f | 0), 0xa, 0x1f);
    ...
    field_name: ftrans_irq_stat          field_range: 0:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x10020804, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10020804, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10020804, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10020804, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);

    /*testing for RO VERSION: addr=0x10020ffc*/
    /*
    field_name: ver                      field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x10020ffc, 0x20400, 0xFFFFFFFF);
    ...
    */
    ...
    udma0_clk_en(DISABLE);

    /*testing for EWR CH0_CFG_MSRCADDR: addr=0x10020008*/
    /*
    field_name: src_base                 field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10020008);

    /*testing for EWR CH0_CFG_MDSTADDR: addr=0x1002000c*/
    /*
    field_name: dst_base                 field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x1002000c);
    ...
    */
    ...
    field_name: rsau                     field_range: 15:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10020024);

    /*testing for EWR CH0_CFG_MLLA: addr=0x10020028*/
    /*
    field_name: lla                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10020028);
    ...
    */
    ...
    field_name: ftrans_irq_stat          field_range: 0:0              field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x10020804);

    /*testing for RO VERSION: addr=0x10020ffc*/
    /*
    field_name: ver                      field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x10020ffc);
