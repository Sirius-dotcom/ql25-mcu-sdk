...
void TIMER_Config(void)
{
    ...
    Timer_InputTriggerSourceSelect(ADVANCED_TIMER3, ADV_TIMER_TIM_SMCR_TS_ETRF);

    Timer_ExternalClockMode1Config(ADVANCED_TIMER3, ADV_TIMER_TIM_SMCR_ETP_DISABLE,ADV_TIMER_TIM_SMCR_ETPS_PRESCALER,ADV_TIMER_TIM_SMCR_ETF_NO_FILTER);
