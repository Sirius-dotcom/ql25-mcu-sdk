...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for  TIM_CR1: addr=0x10083000*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083000,0x0);

    /*testing for  TIM_CR2: addr=0x10083004*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083004,0x0);

    /*testing for  TIM_SMCR: addr=0x10083008*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083008,0x0);

    /*testing for  TIM_DIER: addr=0x1008300c*/
    /*
    field_name: reserved                 field_range: 31:15            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x1008300c,0x0);

    /*testing for  TIM_SR: addr=0x10083010*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083010,0x0);

    /*testing for  TIM_EGR: addr=0x10083014*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083014,0x0);

    /*testing for  TIM_CCER: addr=0x10083020*/
    /*
    field_name: reserved                 field_range: 31:18            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x10083020,0x1c000);

    /*testing for EWR TIM_CNT: addr=0x10083024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10083024,0x0);

    /*testing for EWR TIM_PSC: addr=0x10083028*/
    /*
    field_name: psc                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10083028,0x0);

    /*testing for EWR TIM_ARR: addr=0x1008302c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x1008302c,0xffffffff);

    /*testing for  TIM_RCR: addr=0x10083030*/
    /*
    field_name: reserved                 field_range: 31:15            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x10083030,0x0);

    /*testing for EWR TIM_CCR1: addr=0x10083034*/
    /*
    field_name: ccr1                     field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10083034,0x0);

    /*testing for EWR TIM_CCR2: addr=0x10083038*/
    /*
    field_name: ccr2                     field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10083038,0x0);

    /*testing for EWR TIM_CCR3: addr=0x1008303c*/
    /*
    field_name: ccr3                     field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x1008303c,0x0);

    /*testing for EWR TIM_CCR4: addr=0x10083040*/
    /*
    field_name: ccr4                     field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10083040,0x0);

    /*testing for  TIM_DCR: addr=0x10083048*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083048,0x0);

    /*testing for RO TIM_VERSION: addr=0x10083050*/
    /*
    field_name: git_ver                  field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x10083050,0x10010);

    /*testing for EWR TIM_IC_PSC_REP: addr=0x10083054*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083054,0x0);

    /*testing for  TIM_AF1: addr=0x10083058*/
    /*
    field_name: reserved                 field_range: 31:18            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x10083058,0x0);

    /*testing for  TIM_AF2: addr=0x1008305c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1008305c,0x0);

    /*testing for  TIM_TISEL: addr=0x10083060*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083060,0x0);

    /*testing for EWR TIM_OUTPUT_DELAY: addr=0x10083064*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10083064,0x0);
    ...
    field_name: cen                      field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083000, 0x0, (0x00000000 & 0x3ef | 0), 0x0, 0x3ef);

    REG_PWR_Double_Check(0x10083000, 0x0, (0xFFFFFFFF & 0x3ef | 0), 0x3ef, 0x3ef);

    REG_PWR_Double_Check(0x10083000, 0x0, (0x55555555 & 0x3ef | 0), 0x145, 0x3ef);

    REG_PWR_Double_Check(0x10083000, 0x0, (0xAAAAAAAA & 0x3ef | 0), 0x2aa, 0x3ef);
    ...
    field_name: ccpc                     field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083004, 0x0, (0x00000000 & 0x7ffd | 0), 0x0, 0x7ffd);

    REG_PWR_Double_Check(0x10083004, 0x0, (0xFFFFFFFF & 0x7ffd | 0), 0x7ffd, 0x7ffd);

    REG_PWR_Double_Check(0x10083004, 0x0, (0x55555555 & 0x7ffd | 0), 0x5555, 0x7ffd);

    REG_PWR_Double_Check(0x10083004, 0x0, (0xAAAAAAAA & 0x7ffd | 0), 0x2aa8, 0x7ffd);
    ...
    field_name: sms                      field_range: 3:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083008, 0x0, (0x00000000 & 0x3ffff | 0), 0x0, 0x3ffff);

    REG_PWR_Double_Check(0x10083008, 0x0, (0xFFFFFFFF & 0x3ffff | 0), 0x3ffff, 0x3ffff);

    REG_PWR_Double_Check(0x10083008, 0x0, (0x55555555 & 0x3ffff | 0), 0x15555, 0x3ffff);

    REG_PWR_Double_Check(0x10083008, 0x0, (0xAAAAAAAA & 0x3ffff | 0), 0x2aaaa, 0x3ffff);
    ...
    field_name: uie                      field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1008300c, 0x0, (0x00000000 & 0x7fff | 0), 0x0, 0x7fff);

    REG_PWR_Double_Check(0x1008300c, 0x0, (0xFFFFFFFF & 0x7fff | 0), 0x7fff, 0x7fff);

    REG_PWR_Double_Check(0x1008300c, 0x0, (0x55555555 & 0x7fff | 0), 0x5555, 0x7fff);

    REG_PWR_Double_Check(0x1008300c, 0x0, (0xAAAAAAAA & 0x7fff | 0), 0x2aaa, 0x7fff);
    ...
    field_name: uif                      field_range: 0:0              field_access: rc  
    */
    REG_PWR_Double_Check(0x10083010, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10083010, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10083010, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10083010, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_PWR_Double_Check(0x10083014, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10083014, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10083014, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x10083014, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: cc1e                     field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083020, 0x1c000, (0x00000000 & 0x1ffff | 0), 0x0, 0x1ffff);

    REG_PWR_Double_Check(0x10083020, 0x1c000, (0xFFFFFFFF & 0x1ffff | 0), 0x1ffff, 0x1ffff);

    REG_PWR_Double_Check(0x10083020, 0x1c000, (0x55555555 & 0x1ffff | 0), 0x15555, 0x1ffff);

    REG_PWR_Double_Check(0x10083020, 0x1c000, (0xAAAAAAAA & 0x1ffff | 0), 0xaaaa, 0x1ffff);

    /*testing for EWR TIM_CNT: addr=0x10083024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10083024, 0x0);

    /*testing for EWR TIM_PSC: addr=0x10083028*/
    /*
    field_name: psc                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10083028, 0x0);

    /*testing for EWR TIM_ARR: addr=0x1008302c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x1008302c, 0xffffffff);
    ...
    field_name: rep                      field_range: 7:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083030, 0x0, (0x00000000 & 0x7fff | 0), 0x0, 0x7fff);

    REG_PWR_Double_Check(0x10083030, 0x0, (0xFFFFFFFF & 0x7fff | 0), 0x7fff, 0x7fff);

    REG_PWR_Double_Check(0x10083030, 0x0, (0x55555555 & 0x7fff | 0), 0x5555, 0x7fff);

    REG_PWR_Double_Check(0x10083030, 0x0, (0xAAAAAAAA & 0x7fff | 0), 0x2aaa, 0x7fff);

    /*testing for EWR TIM_CCR1: addr=0x10083034*/
    /*
    field_name: ccr1                     field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10083034, 0x0);

    /*testing for EWR TIM_CCR2: addr=0x10083038*/
    /*
    field_name: ccr2                     field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10083038, 0x0);

    /*testing for EWR TIM_CCR3: addr=0x1008303c*/
    /*
    field_name: ccr3                     field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x1008303c, 0x0);

    /*testing for EWR TIM_CCR4: addr=0x10083040*/
    /*
    field_name: ccr4                     field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10083040, 0x0);
    ...
    field_name: dba                      field_range: 4:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083048, 0x0, (0x00000000 & 0x1f1f | 0), 0x0, 0x1f1f);

    REG_PWR_Double_Check(0x10083048, 0x0, (0xFFFFFFFF & 0x1f1f | 0), 0x1f1f, 0x1f1f);

    REG_PWR_Double_Check(0x10083048, 0x0, (0x55555555 & 0x1f1f | 0), 0x1515, 0x1f1f);

    REG_PWR_Double_Check(0x10083048, 0x0, (0xAAAAAAAA & 0x1f1f | 0), 0xa0a, 0x1f1f);

    /*testing for RO TIM_VERSION: addr=0x10083050*/
    /*
    field_name: git_ver                  field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x10083050, 0x10010, 0xFFFFFFFF);
    ...
    field_name: ic1psc_rep               field_range: 7:0              field_access: rw  
    */
    REG_EWR_Double_Check(0x10083054, 0x0);
    ...
    field_name: bkine                    field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083058, 0x0, (0x00000000 & 0x3cf07 | 0), 0x0, 0x3cf07);

    REG_PWR_Double_Check(0x10083058, 0x0, (0xFFFFFFFF & 0x3cf07 | 0), 0x3cf07, 0x3cf07);

    REG_PWR_Double_Check(0x10083058, 0x0, (0x55555555 & 0x3cf07 | 0), 0x14505, 0x3cf07);

    REG_PWR_Double_Check(0x10083058, 0x0, (0xAAAAAAAA & 0x3cf07 | 0), 0x28a02, 0x3cf07);
    ...
    field_name: bk2ine                   field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1008305c, 0x0, (0x00000000 & 0xf07 | 0), 0x0, 0xf07);

    REG_PWR_Double_Check(0x1008305c, 0x0, (0xFFFFFFFF & 0xf07 | 0), 0xf07, 0xf07);

    REG_PWR_Double_Check(0x1008305c, 0x0, (0x55555555 & 0xf07 | 0), 0x505, 0xf07);

    REG_PWR_Double_Check(0x1008305c, 0x0, (0xAAAAAAAA & 0xf07 | 0), 0xa02, 0xf07);
    ...
    field_name: ti1sel                   field_range: 3:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10083060, 0x0, (0x00000000 & 0xf0f0f0f | 0), 0x0, 0xf0f0f0f);

    REG_PWR_Double_Check(0x10083060, 0x0, (0xFFFFFFFF & 0xf0f0f0f | 0), 0xf0f0f0f, 0xf0f0f0f);

    REG_PWR_Double_Check(0x10083060, 0x0, (0x55555555 & 0xf0f0f0f | 0), 0x5050505, 0xf0f0f0f);

    REG_PWR_Double_Check(0x10083060, 0x0, (0xAAAAAAAA & 0xf0f0f0f | 0), 0xa0a0a0a, 0xf0f0f0f);
    ...
    field_name: oc1_delay                field_range: 7:0              field_access: rw  
    */
    REG_EWR_Double_Check(0x10083064, 0x0);
    ...
    */
    ...
    advanced_timer3_clk_en(DISABLE);
    ...
    */
    ...
    field_name: cc1e                     field_range: 0:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083020);

    /*testing for EWR TIM_CNT: addr=0x10083024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083024);

    /*testing for EWR TIM_PSC: addr=0x10083028*/
    /*
    field_name: psc                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083028);

    /*testing for EWR TIM_ARR: addr=0x1008302c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x1008302c);
    ...
    field_name: rep                      field_range: 7:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083030);

    /*testing for EWR TIM_CCR1: addr=0x10083034*/
    /*
    field_name: ccr1                     field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083034);

    /*testing for EWR TIM_CCR2: addr=0x10083038*/
    /*
    field_name: ccr2                     field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083038);

    /*testing for EWR TIM_CCR3: addr=0x1008303c*/
    /*
    field_name: ccr3                     field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x1008303c);

    /*testing for EWR TIM_CCR4: addr=0x10083040*/
    /*
    field_name: ccr4                     field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083040);
    ...
    field_name: dba                      field_range: 4:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10083048);

    /*testing for RO TIM_VERSION: addr=0x10083050*/
    /*
    field_name: git_ver                  field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x10083050);
