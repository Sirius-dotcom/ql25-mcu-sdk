...
void TIMER_Config(void)
{
    ...
    Timer_ChannelFastOutputDelay(ADVANCED_TIMER0, TIMER_CH_1, ADV_TIMER_TIM_OUTPUT_DELAY_OC1_DELAY(500));
    Timer_ChannelFastOutput(ADVANCED_TIMER0, TIMER_CH_1, ADV_TIMER_TIM_CCMR1_OC1FE_VAL(0));
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_2, 4000);
    ...
    Timer_ChannelFastOutputDelay(ADVANCED_TIMER0, TIMER_CH_3, ADV_TIMER_TIM_OUTPUT_DELAY_OC3_DELAY(500));
    Timer_ChannelFastOutput(ADVANCED_TIMER0, TIMER_CH_3, ADV_TIMER_TIM_CCMR2_OC3FE_VAL(0));
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_3, 8000);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_4, 8000);
