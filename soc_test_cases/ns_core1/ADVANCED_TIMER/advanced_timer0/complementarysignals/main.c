...
void TIMER_Config(void)
{
    ...
    timer_ocinitpara.outputnstate = ADV_TIMER_TIM_CCER_CC2NE_ENABLE;
    ...
    timer_ocinitpara.outputnstate = ADV_TIMER_TIM_CCER_CC3NE_ENABLE;
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_1, 3999);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_2, 7999);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_3, 11999);
