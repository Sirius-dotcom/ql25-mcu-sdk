...
void TIMER_Config(void)
{
    ...
    Timer_CKDIV(ADVANCED_TIMER0, ADV_TIMER_TIM_CR1_CKD_CKD2);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER0, TIMER_CH_1, 500);
    ...
    Timer_BreakConfig(ADVANCED_TIMER0, &timer_breakpara);
