...
void ADVANCED_TIMER1_IRQHandler(void)
{
    if (SET == Timer_InterruptFlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE_ENABLE)) {
        ...
        Timer_InterruptDisable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC1IE_ENABLE );
        ...
        Timer_InterruptDisable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC3IE_ENABLE );
        ...
        Timer_InterruptDisable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_CC4IE_ENABLE );
...
void TIMER_Config(void)
{
    ...
    Timer_CounterAlignment(ADVANCED_TIMER1, ADV_TIMER_TIM_CR1_CMS_CENTER_ALIGNED3);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_2,400);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_3,600);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1,TIMER_CH_4,800);
    Timer_ChannelOutputModeConfig(ADVANCED_TIMER1, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4M_PWM1);
    Timer_ChannelOutputShadowConfig(ADVANCED_TIMER1, TIMER_CH_4, ADV_TIMER_TIM_CCMR2_OC4PE_DISABLE);

    Timer_InterruptEnable(ADVANCED_TIMER1, (ADV_TIMER_TIM_DIER_CC1IE | ADV_TIMER_TIM_DIER_CC2IE | ADV_TIMER_TIM_DIER_CC3IE | ADV_TIMER_TIM_DIER_CC4IE ));
