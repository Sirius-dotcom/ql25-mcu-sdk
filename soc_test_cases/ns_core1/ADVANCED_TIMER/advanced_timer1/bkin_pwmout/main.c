...
{
    if(bkin==0 & bkin2==0){
        Timer_InterruptDisable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_BIE); 
    }

    if(Timer_FlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_BIF) == SET)
    {
        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_BIF);
        bkin = 0;    
    }

    if(Timer_FlagGet(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_B2IF) == SET)
    { 
        Timer_InterruptFlagClear(ADVANCED_TIMER1, ADV_TIMER_TIM_SR_B2IF);
        bkin2 = 0;    
    }
...
void TIMER_Config(void)
{
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_1, 10);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_2, 20);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_3, 30);
    ...
    Timer_ChannelOutputPulseValueConfig(ADVANCED_TIMER1, TIMER_CH_4, 40);
    ...
    Timer_InterruptEnable(ADVANCED_TIMER1, ADV_TIMER_TIM_DIER_BIE); 
    ...
    Timer_BreakConfig(ADVANCED_TIMER1, &break_init);

    Timer_AutoMaticOutputEnable(ADVANCED_TIMER1);
    /* ADVANCED_TIMER1 primary output function enable */
    Timer_PrimaryOutputConfig(ADVANCED_TIMER1, ENABLE);
    Timer_BKAF1(ADVANCED_TIMER1, ENABLE);
    Timer_BK2AF2(ADVANCED_TIMER1, ENABLE);
    Timer_BreakEnable(ADVANCED_TIMER1);
    Timer_Break2Enable(ADVANCED_TIMER1);

}

void iomux_config(void)
{
    iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER1_TIM_BKIN_0_IOF_IVAL,ADVANCED_TIMER1_TIM_BKIN_0_PAD_SEL,ADVANCED_TIMER1_TIM_BKIN_0_HS_SEL,0,0);
    iomux_ls_iof_ival_cfg(IOMUX_BASE,ADVANCED_TIMER1_TIM_BKIN2_0_IOF_IVAL,ADVANCED_TIMER1_TIM_BKIN2_0_PAD_SEL,ADVANCED_TIMER1_TIM_BKIN2_0_HS_SEL,0,0);
