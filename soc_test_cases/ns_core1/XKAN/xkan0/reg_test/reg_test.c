...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for RO RELEASE: addr=0x11000000*/
    /*
    field_name: version                  field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x11000000,0x20201);

    /*testing for  CFG_MCR: addr=0x11000004*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000004,0x36004);

    /*testing for  CFG_TEST: addr=0x11000008*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000008,0x0);

    /*testing for  CFG_PSR: addr=0x1100000c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1100000c,0x0);

    /*testing for  CFG_GLOBAL_FILTER: addr=0x11000014*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000014,0x3c);

    /*testing for  CFG_ST_FILTER: addr=0x11000018*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000018,0x0);

    /*testing for  CFG_EX_FILTER: addr=0x1100001c*/
    /*
    field_name: reserved                 field_range: 31:20            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x1100001c,0x0);

    /*testing for  CFG_STIDM: addr=0x11000020*/
    /*
    field_name: reserved                 field_range: 31:11            field_access: ro  
    field_name: sidm                     field_range: 10:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x11000020,0x7ff);

    /*testing for  CFG_EXIDM: addr=0x11000024*/
    /*
    field_name: reserved                 field_range: 31:29            field_access: ro  
    field_name: eidm                     field_range: 28:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x11000024,0x1fffffff);

    /*testing for  CFG_NBTR: addr=0x11000028*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000028,0x1040600);

    /*testing for  CFG_DBTR: addr=0x1100002c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1100002c,0x0);

    /*testing for  CFG_ISO_MODE: addr=0x11000030*/
    /*
    field_name: reserved                 field_range: 31:1             field_access: ro  
    field_name: enable                   field_range: 0:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x11000030,0x1);

    /*testing for  CFG_RXDATL_RSP: addr=0x11000040*/
    /*
    field_name: low                      field_range: 31:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x11000040,0x0);

    /*testing for  CFG_RXDATH_RSP: addr=0x11000044*/
    /*
    field_name: high                     field_range: 31:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x11000044,0x0);

    /*testing for  CFG_RXFIFO0: addr=0x11000048*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000048,0x0);

    /*testing for  CFG_RXFIFO0_STATUS: addr=0x1100004c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1100004c,0x0);

    /*testing for  CFG_RXFIFO0_ACK: addr=0x11000050*/
    /*
    field_name: rxf0_ack                 field_range: 31:31            field_access: wo  
    field_name: reserved                 field_range: 30:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x11000050,0x0);

    /*testing for  CFG_RXBUF: addr=0x11000054*/
    /*
    field_name: reserved                 field_range: 31:11            field_access: ro  
    field_name: rxbuf_addr               field_range: 10:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x11000054,0x0);

    /*testing for  CFG_RXFIFO1: addr=0x11000058*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000058,0x0);

    /*testing for  CFG_RXFIFO1_STATUS: addr=0x1100005c*/
    /*
    field_name: reserved                 field_range: 31:26            field_access: ro  
    ...
    field_name: reserved                 field_range: 0:0              field_access: ro  
    */
    REG_DefVal_CHECK(0x1100005c,0x0);

    /*testing for  CFG_RXFIFO1_ACK: addr=0x11000060*/
    /*
    field_name: rxf1_ack                 field_range: 31:31            field_access: wo  
    field_name: reserved                 field_range: 30:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x11000060,0x0);

    /*testing for  CFG_RX_DSIZE: addr=0x11000064*/
    /*
    field_name: reserved                 field_range: 31:11            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x11000064,0x0);

    /*testing for  CFG_TXBUF: addr=0x11000070*/
    /*
    field_name: reserved                 field_range: 31:31            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x11000070,0x0);

    /*testing for RO CFG_TXFIFO_STATUS: addr=0x11000074*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x11000074,0x0);

    /*testing for  CFG_TX_DSIZE: addr=0x11000078*/
    /*
    field_name: reserved                 field_range: 31:3             field_access: ro  
    field_name: txb_dsize                field_range: 2:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x11000078,0x0);

    /*testing for  CFG_TXABORT_FINISH: addr=0x11000084*/
    /*
    field_name: finish                   field_range: 31:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x11000084,0x0);

    /*testing for  CFG_TXREQ_PENDING: addr=0x11000088*/
    /*
    field_name: req_pending              field_range: 31:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x11000088,0x0);

    /*testing for  CFG_TXB_TRANS: addr=0x1100008c*/
    /*
    field_name: tx_complete              field_range: 31:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x1100008c,0x0);

    /*testing for  CFG_TIME_STAMP: addr=0x11000090*/
    /*
    field_name: reserved                 field_range: 31:16            field_access: ro  
    field_name: value                    field_range: 15:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x11000090,0x0);

    /*testing for  CFG_TIME_DIV: addr=0x11000094*/
    /*
    field_name: reserved                 field_range: 31:4             field_access: ro  
    field_name: div_num                  field_range: 3:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x11000094,0x0);

    /*testing for  CFG_TRANS_DELAY_COMP: addr=0x11000098*/
    /*
    field_name: reserved                 field_range: 31:7             field_access: ro  
    field_name: offset_value             field_range: 6:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x11000098,0x0);

    /*testing for  CFG_ESR: addr=0x1100009c*/
    /*
    field_name: reserved                 field_range: 31:22            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x1100009c,0x10000);

    /*testing for  CFG_TRANS_ERR: addr=0x110000a0*/
    /*
    field_name: tx_num                   field_range: 31:0             field_access: w1c 
    */
    REG_DefVal_CHECK(0x110000a0,0x0);

    /*testing for  CFG_INT_EN: addr=0x110000b4*/
    /*
    field_name: reserved                 field_range: 31:23            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x110000b4,0x0);

    /*testing for  CFG_INT_STATUS: addr=0x110000b8*/
    /*
    field_name: reserved                 field_range: 31:23            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x110000b8,0x0);
    ...
    field_name: version                  field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x11000000, 0x20201, 0xFFFFFFFF);
    ...
    field_name: enable                   field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000004, 0x36004, (0x00000000 & 0x7ebdb | 4), 0x0, 0x7ebdb);

    REG_PWR_Double_Check(0x11000004, 0x36004, (0xFFFFFFFF & 0x7ebdb | 4), 0x7ebdb, 0x7ebdb);

    REG_PWR_Double_Check(0x11000004, 0x36004, (0x55555555 & 0x7ebdb | 4), 0x54151, 0x7ebdb);

    REG_PWR_Double_Check(0x11000004, 0x36004, (0xAAAAAAAA & 0x7ebdb | 4), 0x2aa8a, 0x7ebdb);
    ...
    field_name: lbkm                     field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000008, 0x0, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x11000008, 0x0, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x11000008, 0x0, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x11000008, 0x0, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);
    ...
    field_name: ide                      field_range: 0:0              field_access: w1c 
    */
    REG_PWR_Double_Check(0x1100000c, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100000c, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100000c, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100000c, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: reject_ex_remote         field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000014, 0x3c, (0x00000000 & 0x3f | 0), 0x0, 0x3f);

    REG_PWR_Double_Check(0x11000014, 0x3c, (0xFFFFFFFF & 0x3f | 0), 0x3f, 0x3f);

    REG_PWR_Double_Check(0x11000014, 0x3c, (0x55555555 & 0x3f | 0), 0x15, 0x3f);

    REG_PWR_Double_Check(0x11000014, 0x3c, (0xAAAAAAAA & 0x3f | 0), 0x2a, 0x3f);
    ...
    field_name: stflt_addr               field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000018, 0x0, (0x00000000 & 0xff7ff | 0), 0x0, 0xff7ff);

    REG_PWR_Double_Check(0x11000018, 0x0, (0xFFFFFFFF & 0xff7ff | 0), 0xff7ff, 0xff7ff);

    REG_PWR_Double_Check(0x11000018, 0x0, (0x55555555 & 0xff7ff | 0), 0x55555, 0xff7ff);

    REG_PWR_Double_Check(0x11000018, 0x0, (0xAAAAAAAA & 0xff7ff | 0), 0xaa2aa, 0xff7ff);
    ...
    field_name: exflt_addr               field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x1100001c, 0x0, (0x00000000 & 0xff7ff | 0), 0x0, 0xff7ff);

    REG_PWR_Double_Check(0x1100001c, 0x0, (0xFFFFFFFF & 0xff7ff | 0), 0xff7ff, 0xff7ff);

    REG_PWR_Double_Check(0x1100001c, 0x0, (0x55555555 & 0xff7ff | 0), 0x55555, 0xff7ff);

    REG_PWR_Double_Check(0x1100001c, 0x0, (0xAAAAAAAA & 0xff7ff | 0), 0xaa2aa, 0xff7ff);
    ...
    field_name: sidm                     field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000020, 0x7ff, (0x00000000 & 0x7ff | 0), 0x0, 0x7ff);

    REG_PWR_Double_Check(0x11000020, 0x7ff, (0xFFFFFFFF & 0x7ff | 0), 0x7ff, 0x7ff);

    REG_PWR_Double_Check(0x11000020, 0x7ff, (0x55555555 & 0x7ff | 0), 0x555, 0x7ff);

    REG_PWR_Double_Check(0x11000020, 0x7ff, (0xAAAAAAAA & 0x7ff | 0), 0x2aa, 0x7ff);
    ...
    field_name: eidm                     field_range: 28:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000024, 0x1fffffff, (0x00000000 & 0x1fffffff | 0), 0x0, 0x1fffffff);

    REG_PWR_Double_Check(0x11000024, 0x1fffffff, (0xFFFFFFFF & 0x1fffffff | 0), 0x1fffffff, 0x1fffffff);

    REG_PWR_Double_Check(0x11000024, 0x1fffffff, (0x55555555 & 0x1fffffff | 0), 0x15555555, 0x1fffffff);

    REG_PWR_Double_Check(0x11000024, 0x1fffffff, (0xAAAAAAAA & 0x1fffffff | 0), 0xaaaaaaa, 0x1fffffff);
    ...
    field_name: nbrp                     field_range: 8:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000028, 0x1040600, (0x00000000 & 0x7fffffff | 0), 0x0, 0x7fffffff);

    REG_PWR_Double_Check(0x11000028, 0x1040600, (0xFFFFFFFF & 0x7fffffff | 0), 0x7fffffff, 0x7fffffff);

    REG_PWR_Double_Check(0x11000028, 0x1040600, (0x55555555 & 0x7fffffff | 0), 0x55555555, 0x7fffffff);

    REG_PWR_Double_Check(0x11000028, 0x1040600, (0xAAAAAAAA & 0x7fffffff | 0), 0x2aaaaaaa, 0x7fffffff);
    ...
    field_name: dbrp                     field_range: 4:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1100002c, 0x0, (0x00000000 & 0x3ffff | 0), 0x0, 0x3ffff);

    REG_PWR_Double_Check(0x1100002c, 0x0, (0xFFFFFFFF & 0x3ffff | 0), 0x3ffff, 0x3ffff);

    REG_PWR_Double_Check(0x1100002c, 0x0, (0x55555555 & 0x3ffff | 0), 0x15555, 0x3ffff);

    REG_PWR_Double_Check(0x1100002c, 0x0, (0xAAAAAAAA & 0x3ffff | 0), 0x2aaaa, 0x3ffff);
    ...
    field_name: enable                   field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000030, 0x1, (0x00000000 & 0x1 | 0), 0x0, 0x1);

    REG_PWR_Double_Check(0x11000030, 0x1, (0xFFFFFFFF & 0x1 | 0), 0x1, 0x1);

    REG_PWR_Double_Check(0x11000030, 0x1, (0x55555555 & 0x1 | 0), 0x1, 0x1);

    REG_PWR_Double_Check(0x11000030, 0x1, (0xAAAAAAAA & 0x1 | 0), 0x0, 0x1);

    /*testing for  CFG_RXDATL_RSP: addr=0x11000040*/
    /*
    field_name: low                      field_range: 31:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x11000040, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000040, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000040, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000040, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);

    /*testing for  CFG_RXDATH_RSP: addr=0x11000044*/
    /*
    field_name: high                     field_range: 31:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x11000044, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000044, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000044, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000044, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: rxff0_addr               field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000048, 0x0, (0x00000000 & 0x83fff7ff | 0), 0x0, 0x83fff7ff);

    REG_PWR_Double_Check(0x11000048, 0x0, (0xFFFFFFFF & 0x83fff7ff | 0), 0x83fff7ff, 0x83fff7ff);

    REG_PWR_Double_Check(0x11000048, 0x0, (0x55555555 & 0x83fff7ff | 0), 0x1555555, 0x83fff7ff);

    REG_PWR_Double_Check(0x11000048, 0x0, (0xAAAAAAAA & 0x83fff7ff | 0), 0x82aaa2aa, 0x83fff7ff);
    ...
    field_name: reserved                 field_range: 0:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x1100004c, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100004c, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100004c, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100004c, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: reserved                 field_range: 30:0             field_access: ro  
    */
    REG_PWR_Double_Check(0x11000050, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000050, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000050, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000050, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: rxbuf_addr               field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000054, 0x0, (0x00000000 & 0x7ff | 0), 0x0, 0x7ff);

    REG_PWR_Double_Check(0x11000054, 0x0, (0xFFFFFFFF & 0x7ff | 0), 0x7ff, 0x7ff);

    REG_PWR_Double_Check(0x11000054, 0x0, (0x55555555 & 0x7ff | 0), 0x555, 0x7ff);

    REG_PWR_Double_Check(0x11000054, 0x0, (0xAAAAAAAA & 0x7ff | 0), 0x2aa, 0x7ff);
    ...
    field_name: rxff1_addr               field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000058, 0x0, (0x00000000 & 0x83fff7ff | 0), 0x0, 0x83fff7ff);

    REG_PWR_Double_Check(0x11000058, 0x0, (0xFFFFFFFF & 0x83fff7ff | 0), 0x83fff7ff, 0x83fff7ff);

    REG_PWR_Double_Check(0x11000058, 0x0, (0x55555555 & 0x83fff7ff | 0), 0x1555555, 0x83fff7ff);

    REG_PWR_Double_Check(0x11000058, 0x0, (0xAAAAAAAA & 0x83fff7ff | 0), 0x82aaa2aa, 0x83fff7ff);
    ...
    field_name: reserved                 field_range: 0:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x1100005c, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100005c, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100005c, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100005c, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: reserved                 field_range: 30:0             field_access: ro  
    */
    REG_PWR_Double_Check(0x11000060, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000060, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000060, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000060, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: f0_dsize                 field_range: 2:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000064, 0x0, (0x00000000 & 0x777 | 0), 0x0, 0x777);

    REG_PWR_Double_Check(0x11000064, 0x0, (0xFFFFFFFF & 0x777 | 0), 0x777, 0x777);

    REG_PWR_Double_Check(0x11000064, 0x0, (0x55555555 & 0x777 | 0), 0x555, 0x777);

    REG_PWR_Double_Check(0x11000064, 0x0, (0xAAAAAAAA & 0x777 | 0), 0x222, 0x777);
    ...
    field_name: txbuf_addr               field_range: 10:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x11000070, 0x0, (0x00000000 & 0x3f3f07ff | 0), 0x0, 0x3f3f07ff);

    REG_PWR_Double_Check(0x11000070, 0x0, (0xFFFFFFFF & 0x3f3f07ff | 0), 0x3f3f07ff, 0x3f3f07ff);

    REG_PWR_Double_Check(0x11000070, 0x0, (0x55555555 & 0x3f3f07ff | 0), 0x15150555, 0x3f3f07ff);

    REG_PWR_Double_Check(0x11000070, 0x0, (0xAAAAAAAA & 0x3f3f07ff | 0), 0x2a2a02aa, 0x3f3f07ff);
    ...
    field_name: txff_entry_num           field_range: 5:0              field_access: ro  
    */
    REG_RO_Double_Check(0x11000074, 0x0, 0xFFFFFFFF);
    ...
    field_name: txb_dsize                field_range: 2:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000078, 0x0, (0x00000000 & 0x7 | 0), 0x0, 0x7);

    REG_PWR_Double_Check(0x11000078, 0x0, (0xFFFFFFFF & 0x7 | 0), 0x7, 0x7);

    REG_PWR_Double_Check(0x11000078, 0x0, (0x55555555 & 0x7 | 0), 0x5, 0x7);

    REG_PWR_Double_Check(0x11000078, 0x0, (0xAAAAAAAA & 0x7 | 0), 0x2, 0x7);

    /*testing for  CFG_TXABORT_FINISH: addr=0x11000084*/
    /*
    field_name: finish                   field_range: 31:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x11000084, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000084, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000084, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000084, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);

    /*testing for  CFG_TXREQ_PENDING: addr=0x11000088*/
    /*
    field_name: req_pending              field_range: 31:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x11000088, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000088, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000088, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000088, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);

    /*testing for  CFG_TXB_TRANS: addr=0x1100008c*/
    /*
    field_name: tx_complete              field_range: 31:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x1100008c, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100008c, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100008c, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100008c, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: value                    field_range: 15:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x11000090, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000090, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000090, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x11000090, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: div_num                  field_range: 3:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000094, 0x0, (0x00000000 & 0xf | 0), 0x0, 0xf);

    REG_PWR_Double_Check(0x11000094, 0x0, (0xFFFFFFFF & 0xf | 0), 0xf, 0xf);

    REG_PWR_Double_Check(0x11000094, 0x0, (0x55555555 & 0xf | 0), 0x5, 0xf);

    REG_PWR_Double_Check(0x11000094, 0x0, (0xAAAAAAAA & 0xf | 0), 0xa, 0xf);
    ...
    field_name: offset_value             field_range: 6:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x11000098, 0x0, (0x00000000 & 0x7f | 0), 0x0, 0x7f);

    REG_PWR_Double_Check(0x11000098, 0x0, (0xFFFFFFFF & 0x7f | 0), 0x7f, 0x7f);

    REG_PWR_Double_Check(0x11000098, 0x0, (0x55555555 & 0x7f | 0), 0x55, 0x7f);

    REG_PWR_Double_Check(0x11000098, 0x0, (0xAAAAAAAA & 0x7f | 0), 0x2a, 0x7f);
    ...
    field_name: tec                      field_range: 7:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x1100009c, 0x10000, (0x00000000 & 0x0 | 65536), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100009c, 0x10000, (0xFFFFFFFF & 0x0 | 65536), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100009c, 0x10000, (0x55555555 & 0x0 | 65536), 0x0, 0x0);

    REG_PWR_Double_Check(0x1100009c, 0x10000, (0xAAAAAAAA & 0x0 | 65536), 0x0, 0x0);

    /*testing for  CFG_TRANS_ERR: addr=0x110000a0*/
    /*
    field_name: tx_num                   field_range: 31:0             field_access: w1c 
    */
    REG_PWR_Double_Check(0x110000a0, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x110000a0, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x110000a0, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x110000a0, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: rxb_upd_en               field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x110000b4, 0x0, (0x00000000 & 0x7f80ff | 0), 0x0, 0x7f80ff);

    REG_PWR_Double_Check(0x110000b4, 0x0, (0xFFFFFFFF & 0x7f80ff | 0), 0x7f80ff, 0x7f80ff);

    REG_PWR_Double_Check(0x110000b4, 0x0, (0x55555555 & 0x7f80ff | 0), 0x550055, 0x7f80ff);

    REG_PWR_Double_Check(0x110000b4, 0x0, (0xAAAAAAAA & 0x7f80ff | 0), 0x2a80aa, 0x7f80ff);
    ...
    field_name: rxb_upd_int              field_range: 0:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x110000b8, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x110000b8, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x110000b8, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x110000b8, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    */
    ...
    xkan0_clk_en(DISABLE);

    /*testing for RO RELEASE: addr=0x11000000*/
    /*
    field_name: version                  field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x11000000);
    ...
    */
    ...
    field_name: enable                   field_range: 0:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x11000030);

    /*testing for  CFG_RXDATL_RSP: addr=0x11000040*/
    /*
    field_name: low                      field_range: 31:0             field_access: w1c 
    */
    REG_CLK_DIS_CHECK(0x11000040);

    /*testing for  CFG_RXDATH_RSP: addr=0x11000044*/
    /*
    field_name: high                     field_range: 31:0             field_access: w1c 
    */
    REG_CLK_DIS_CHECK(0x11000044);
    ...
    */
    ...
    field_name: txb_dsize                field_range: 2:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x11000078);

    /*testing for  CFG_TXABORT_FINISH: addr=0x11000084*/
    /*
    field_name: finish                   field_range: 31:0             field_access: w1c 
    */
    REG_CLK_DIS_CHECK(0x11000084);

    /*testing for  CFG_TXREQ_PENDING: addr=0x11000088*/
    /*
    field_name: req_pending              field_range: 31:0             field_access: w1c 
    */
    REG_CLK_DIS_CHECK(0x11000088);

    /*testing for  CFG_TXB_TRANS: addr=0x1100008c*/
    /*
    field_name: tx_complete              field_range: 31:0             field_access: w1c 
    */
    REG_CLK_DIS_CHECK(0x1100008c);
    ...
    */
    ...
    field_name: tec                      field_range: 7:0              field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x1100009c);

    /*testing for  CFG_TRANS_ERR: addr=0x110000a0*/
    /*
    field_name: tx_num                   field_range: 31:0             field_access: w1c 
    */
    REG_CLK_DIS_CHECK(0x110000a0);
