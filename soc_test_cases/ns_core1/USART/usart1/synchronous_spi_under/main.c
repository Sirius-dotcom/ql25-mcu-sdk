...
void USART1_IRQHandler(void)
{
    ...
    if(USART_GetITStatus(USART1,USART_STATUS_SPI_SLV_UNDER_RUN) == SET)
    {
        USART_ClearITStatus(USART1,USART_STATUS_SPI_SLV_UNDER_RUN);
        USART_ITConfig(USART1,USART_INT_EN_SPI_SLV_UNDER_RUN_IRQ_EN,DISABLE);
        state3 =0;
        state0 =1;
    }
...
int main(void)
{
    ...
    USART_ITConfig(USART1,USART_INT_EN_SPI_SLV_UNDER_RUN_IRQ_EN,ENABLE);
