...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for  TXDATA: addr=0x10031000*/
    /*
    field_name: reserved                 field_range: 31:9             field_access: ro  
    field_name: tx_data                  field_range: 8:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x10031000,0x0);

    /*testing for RO RXDATA: addr=0x10031004*/
    /*
    field_name: reserved                 field_range: 31:9             field_access: ro  
    field_name: rx_data                  field_range: 8:0              field_access: ro  
    */
    REG_DefVal_CHECK(0x10031004,0x0);

    /*testing for  TXCTRL: addr=0x10031008*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10031008,0x0);

    /*testing for  RXCTRL: addr=0x1003100c*/
    /*
    field_name: reserved                 field_range: 31:21            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x1003100c,0x0);

    /*testing for  INT_EN: addr=0x10031010*/
    /*
    field_name: reserved                 field_range: 31:21            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x10031010,0x0);

    /*testing for  STATUS: addr=0x10031014*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10031014,0x208000);

    /*testing for  DIV: addr=0x10031018*/
    /*
    field_name: reserved                 field_range: 31:21            field_access: ro  
    field_name: baud_div                 field_range: 20:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10031018,0x0);

    /*testing for  SETUP: addr=0x1003101c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1003101c,0xc0050030);

    /*testing for  SPI_SLAVE: addr=0x10031034*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10031034,0x0);

    /*testing for EWR RX_IDLE: addr=0x10031044*/
    /*
    field_name: idle_tout_num            field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10031044,0xffff);

    /*testing for EWR RX_WM: addr=0x10031048*/
    /*
    field_name: wm_tout_num              field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x10031048,0xffff);

    /*testing for RO RX_FIFO_LEFT_ENTRY: addr=0x1003104c*/
    /*
    field_name: reserved                 field_range: 31:5             field_access: ro  
    field_name: left_entry               field_range: 4:0              field_access: ro  
    */
    REG_DefVal_CHECK(0x1003104c,0x0);

    /*testing for RO TX_FIFO_LEFT_ENTRY: addr=0x10031050*/
    /*
    field_name: reserved                 field_range: 31:5             field_access: ro  
    field_name: left_entry               field_range: 4:0              field_access: ro  
    */
    REG_DefVal_CHECK(0x10031050,0x0);

    /*testing for  TX_DATASIZE: addr=0x10031054*/
    /*
    field_name: reserved                 field_range: 31:2             field_access: ro  
    field_name: tx_datasize_num          field_range: 1:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x10031054,0x0);

    /*testing for  RX_DATASIZE: addr=0x10031058*/
    /*
    field_name: reserved                 field_range: 31:2             field_access: ro  
    field_name: rx_datasize_num          field_range: 1:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x10031058,0x0);

    /*testing for  SMARTCARD_SETUP: addr=0x10031060*/
    /*
    field_name: reserved                 field_range: 31:5             field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x10031060,0x0);

    /*testing for  SMARTCARD_TIMING: addr=0x10031064*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x10031064,0x0);

    /*testing for RO IP_VERSION: addr=0x10031068*/
    /*
    field_name: version                  field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x10031068,0x30004);

    /*testing for  ADVANCED_SETUP: addr=0x1003107c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1003107c,0x0);
    ...
    field_name: tx_data                  field_range: 8:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031000, 0x0, (0x00000000 & 0x1ff | 0), 0x0, 0x1ff);

    REG_PWR_Double_Check(0x10031000, 0x0, (0xFFFFFFFF & 0x1ff | 0), 0x1ff, 0x1ff);

    REG_PWR_Double_Check(0x10031000, 0x0, (0x55555555 & 0x1ff | 0), 0x155, 0x1ff);

    REG_PWR_Double_Check(0x10031000, 0x0, (0xAAAAAAAA & 0x1ff | 0), 0xaa, 0x1ff);
    ...
    field_name: rx_data                  field_range: 8:0              field_access: ro  
    */
    REG_RO_Double_Check(0x10031004, 0x0, 0xFFFFFFFF);
    ...
    field_name: txen                     field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031008, 0x0, (0x00000000 & 0x1f0003 | 0), 0x0, 0x1f0003);

    REG_PWR_Double_Check(0x10031008, 0x0, (0xFFFFFFFF & 0x1f0003 | 0), 0x1f0003, 0x1f0003);

    REG_PWR_Double_Check(0x10031008, 0x0, (0x55555555 & 0x1f0003 | 0), 0x150001, 0x1f0003);

    REG_PWR_Double_Check(0x10031008, 0x0, (0xAAAAAAAA & 0x1f0003 | 0), 0xa0002, 0x1f0003);
    ...
    field_name: rxen                     field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1003100c, 0x0, (0x00000000 & 0x1f0003 | 0), 0x0, 0x1f0003);

    REG_PWR_Double_Check(0x1003100c, 0x0, (0xFFFFFFFF & 0x1f0003 | 0), 0x1f0003, 0x1f0003);

    REG_PWR_Double_Check(0x1003100c, 0x0, (0x55555555 & 0x1f0003 | 0), 0x150001, 0x1f0003);

    REG_PWR_Double_Check(0x1003100c, 0x0, (0xAAAAAAAA & 0x1f0003 | 0), 0xa0002, 0x1f0003);
    ...
    field_name: txie                     field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031010, 0x0, (0x00000000 & 0x1fffff | 0), 0x0, 0x1fffff);

    REG_PWR_Double_Check(0x10031010, 0x0, (0xFFFFFFFF & 0x1fffff | 0), 0x1fffff, 0x1fffff);

    REG_PWR_Double_Check(0x10031010, 0x0, (0x55555555 & 0x1fffff | 0), 0x155555, 0x1fffff);

    REG_PWR_Double_Check(0x10031010, 0x0, (0xAAAAAAAA & 0x1fffff | 0), 0xaaaaa, 0x1fffff);
    ...
    field_name: txip                     field_range: 0:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x10031014, 0x208000, (0x00000000 & 0x0 | 2129920), 0x0, 0x0);

    REG_PWR_Double_Check(0x10031014, 0x208000, (0xFFFFFFFF & 0x0 | 2129920), 0x0, 0x0);

    REG_PWR_Double_Check(0x10031014, 0x208000, (0x55555555 & 0x0 | 2129920), 0x0, 0x0);

    REG_PWR_Double_Check(0x10031014, 0x208000, (0xAAAAAAAA & 0x0 | 2129920), 0x0, 0x0);
    ...
    field_name: baud_div                 field_range: 20:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x10031018, 0x0, (0x00000000 & 0x1fffff | 0), 0x0, 0x1fffff);

    REG_PWR_Double_Check(0x10031018, 0x0, (0xFFFFFFFF & 0x1fffff | 0), 0x1fffff, 0x1fffff);

    REG_PWR_Double_Check(0x10031018, 0x0, (0x55555555 & 0x1fffff | 0), 0x155555, 0x1fffff);

    REG_PWR_Double_Check(0x10031018, 0x0, (0xAAAAAAAA & 0x1fffff | 0), 0xaaaaa, 0x1fffff);
    ...
    field_name: parity_en                field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1003101c, 0xc0050030, (0x00000000 & 0xffeffff7 | 0), 0x0, 0xffeffff7);

    REG_PWR_Double_Check(0x1003101c, 0xc0050030, (0xFFFFFFFF & 0xffeffff7 | 0), 0xffeffff7, 0xffeffff7);

    REG_PWR_Double_Check(0x1003101c, 0xc0050030, (0x55555555 & 0xffeffff7 | 0), 0x55455555, 0xffeffff7);

    REG_PWR_Double_Check(0x1003101c, 0xc0050030, (0xAAAAAAAA & 0xffeffff7 | 0), 0xaaaaaaa2, 0xffeffff7);
    ...
    field_name: slv_en                   field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031034, 0x0, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x10031034, 0x0, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x10031034, 0x0, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x10031034, 0x0, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);

    /*testing for EWR RX_IDLE: addr=0x10031044*/
    /*
    field_name: idle_tout_num            field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10031044, 0xffff);

    /*testing for EWR RX_WM: addr=0x10031048*/
    /*
    field_name: wm_tout_num              field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x10031048, 0xffff);
    ...
    field_name: left_entry               field_range: 4:0              field_access: ro  
    */
    REG_RO_Double_Check(0x1003104c, 0x0, 0xFFFFFFFF);
    ...
    field_name: left_entry               field_range: 4:0              field_access: ro  
    */
    REG_RO_Double_Check(0x10031050, 0x0, 0xFFFFFFFF);
    ...
    field_name: tx_datasize_num          field_range: 1:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031054, 0x0, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x10031054, 0x0, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x10031054, 0x0, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x10031054, 0x0, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);
    ...
    field_name: rx_datasize_num          field_range: 1:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031058, 0x0, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x10031058, 0x0, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x10031058, 0x0, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x10031058, 0x0, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);
    ...
    field_name: auto_retry_cnt           field_range: 2:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031060, 0x0, (0x00000000 & 0x1f | 0), 0x0, 0x1f);

    REG_PWR_Double_Check(0x10031060, 0x0, (0xFFFFFFFF & 0x1f | 0), 0x1f, 0x1f);

    REG_PWR_Double_Check(0x10031060, 0x0, (0x55555555 & 0x1f | 0), 0x15, 0x1f);

    REG_PWR_Double_Check(0x10031060, 0x0, (0xAAAAAAAA & 0x1f | 0), 0xa, 0x1f);
    ...
    field_name: guard_time               field_range: 7:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x10031064, 0x0, (0x00000000 & 0xffff | 0), 0x0, 0xffff);

    REG_PWR_Double_Check(0x10031064, 0x0, (0xFFFFFFFF & 0xffff | 0), 0xffff, 0xffff);

    REG_PWR_Double_Check(0x10031064, 0x0, (0x55555555 & 0xffff | 0), 0x5555, 0xffff);

    REG_PWR_Double_Check(0x10031064, 0x0, (0xAAAAAAAA & 0xffff | 0), 0xaaaa, 0xffff);

    /*testing for RO IP_VERSION: addr=0x10031068*/
    /*
    field_name: version                  field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x10031068, 0x30004, 0xFFFFFFFF);
    ...
    field_name: mm_en                    field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1003107c, 0x0, (0x00000000 & 0x38ffff | 0), 0x0, 0x38ffff);

    REG_PWR_Double_Check(0x1003107c, 0x0, (0xFFFFFFFF & 0x38ffff | 0), 0x38ffff, 0x38ffff);

    REG_PWR_Double_Check(0x1003107c, 0x0, (0x55555555 & 0x38ffff | 0), 0x105555, 0x38ffff);

    REG_PWR_Double_Check(0x1003107c, 0x0, (0xAAAAAAAA & 0x38ffff | 0), 0x28aaaa, 0x38ffff);
    ...
    */
    ...
    field_name: slv_en                   field_range: 0:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10031034);

    /*testing for EWR RX_IDLE: addr=0x10031044*/
    /*
    field_name: idle_tout_num            field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10031044);

    /*testing for EWR RX_WM: addr=0x10031048*/
    /*
    field_name: wm_tout_num              field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10031048);
    ...
    */
    ...
    field_name: guard_time               field_range: 7:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x10031064);

    /*testing for RO IP_VERSION: addr=0x10031068*/
    /*
    field_name: version                  field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x10031068);
