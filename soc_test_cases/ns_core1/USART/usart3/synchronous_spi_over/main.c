...
void USART3_IRQHandler(void)
{
    ...
    if(USART_GetITStatus(USART3,USART_STATUS_SPI_SLV_OVER_RUN) == SET)
    {
        USART_ClearITStatus(USART3,USART_STATUS_SPI_SLV_OVER_RUN);
        USART_ITConfig(USART3,USART_INT_EN_SPI_SLV_OVER_RUN_IRQ_EN,DISABLE);
        state0 =0;
    }
...
int main(void)
{
    ...
    USART_ITConfig(USART3,USART_INT_EN_SPI_SLV_OVER_RUN_IRQ_EN,ENABLE);
