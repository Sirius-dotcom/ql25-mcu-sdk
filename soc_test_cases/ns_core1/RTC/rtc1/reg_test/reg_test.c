...
uint32_t volatile delta_mcycle2;
    ...
    /*testing for  CRH: addr=0x100d1000*/
    /*
    field_name: reserved                 field_range: 31:4             field_access: ro  
    field_name: calibration              field_range: 3:3              field_access: rw  
    field_name: owie                     field_range: 2:2              field_access: rw  
    field_name: alrie                    field_range: 1:1              field_access: rw  
    field_name: secie                    field_range: 0:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x100d1000,0x0);

    /*testing for RO VERSION: addr=0x100d1024*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x100d1024,0x10300);
    ...
    field_name: secie                    field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x100d1000, 0x0, (0x00000000 & 0xf | 0), 0x0, 0xf);

    REG_PWR_Double_Check(0x100d1000, 0x0, (0xFFFFFFFF & 0xf | 0), 0xf, 0xf);

    REG_PWR_Double_Check(0x100d1000, 0x0, (0x55555555 & 0xf | 0), 0x5, 0xf);

    REG_PWR_Double_Check(0x100d1000, 0x0, (0xAAAAAAAA & 0xf | 0), 0xa, 0xf);

    /*testing for RO VERSION: addr=0x100d1024*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x100d1024, 0x10300, 0xFFFFFFFF);

    delta_mcycle1=__RV_CSR_READ(CSR_MCYCLE)-start_mcycle1;

    /*********************TEST FOR CLOCK DIVISION 36*********************/

    #ifdef MISC_HAS_RTC1_CLK_DIV
    ...
    */
    ...
    field_name: secie                    field_range: 0:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100d1000);

    /*testing for RO VERSION: addr=0x100d1024*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x100d1024);
