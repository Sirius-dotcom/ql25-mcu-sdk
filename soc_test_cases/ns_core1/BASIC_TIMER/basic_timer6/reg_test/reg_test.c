...
uint32_t volatile delta_mcycle2;
    #ifdef MISC_HAS_BASIC_TIMER6_HAS_CLK

        basic_timer6_clk_en(ENABLE);

    #endif

    /*********************TEST FOR POR DEVAL *********************/

    /*testing for  CR1: addr=0x100e6000*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x100e6000,0x0);

    /*testing for  CR2: addr=0x100e6004*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x100e6004,0x0);

    /*testing for  DIER: addr=0x100e600c*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x100e600c,0x0);

    /*testing for  EGR: addr=0x100e6014*/
    /*
    field_name: reserved                 field_range: 31:1             field_access: ro  
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_DefVal_CHECK(0x100e6014,0x0);

    /*testing for EWR CNT: addr=0x100e6024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100e6024,0x0);

    /*testing for  PSC: addr=0x100e6028*/
    /*
    field_name: reserved                 field_range: 31:16            field_access: ro  
    field_name: psc                      field_range: 15:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100e6028,0x0);

    /*testing for EWR ARR: addr=0x100e602c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x100e602c,0xffffffff);

    /*testing for RO IP_VERSION: addr=0x100e6030*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_DefVal_CHECK(0x100e6030,0x10202);
    ...
    field_name: cen                      field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x100e6000, 0x0, (0x00000000 & 0x8f | 0), 0x0, 0x8f);

    REG_PWR_Double_Check(0x100e6000, 0x0, (0xFFFFFFFF & 0x8f | 0), 0x8f, 0x8f);

    REG_PWR_Double_Check(0x100e6000, 0x0, (0x55555555 & 0x8f | 0), 0x5, 0x8f);

    REG_PWR_Double_Check(0x100e6000, 0x0, (0xAAAAAAAA & 0x8f | 0), 0x8a, 0x8f);
    ...
    field_name: reserved                 field_range: 3:0              field_access: ro  
    */
    REG_PWR_Double_Check(0x100e6004, 0x0, (0x00000000 & 0x70 | 0), 0x0, 0x70);

    REG_PWR_Double_Check(0x100e6004, 0x0, (0xFFFFFFFF & 0x70 | 0), 0x70, 0x70);

    REG_PWR_Double_Check(0x100e6004, 0x0, (0x55555555 & 0x70 | 0), 0x50, 0x70);

    REG_PWR_Double_Check(0x100e6004, 0x0, (0xAAAAAAAA & 0x70 | 0), 0x20, 0x70);
    ...
    field_name: uie                      field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x100e600c, 0x0, (0x00000000 & 0x101 | 0), 0x0, 0x101);

    REG_PWR_Double_Check(0x100e600c, 0x0, (0xFFFFFFFF & 0x101 | 0), 0x101, 0x101);

    REG_PWR_Double_Check(0x100e600c, 0x0, (0x55555555 & 0x101 | 0), 0x101, 0x101);

    REG_PWR_Double_Check(0x100e600c, 0x0, (0xAAAAAAAA & 0x101 | 0), 0x0, 0x101);
    ...
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_PWR_Double_Check(0x100e6014, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x100e6014, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x100e6014, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x100e6014, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);

    /*testing for EWR CNT: addr=0x100e6024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100e6024, 0x0);
    ...
    field_name: psc                      field_range: 15:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x100e6028, 0x0, (0x00000000 & 0xffff | 0), 0x0, 0xffff);

    REG_PWR_Double_Check(0x100e6028, 0x0, (0xFFFFFFFF & 0xffff | 0), 0xffff, 0xffff);

    REG_PWR_Double_Check(0x100e6028, 0x0, (0x55555555 & 0xffff | 0), 0x5555, 0xffff);

    REG_PWR_Double_Check(0x100e6028, 0x0, (0xAAAAAAAA & 0xffff | 0), 0xaaaa, 0xffff);

    /*testing for EWR ARR: addr=0x100e602c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_EWR_Double_Check(0x100e602c, 0xffffffff);

    /*testing for RO IP_VERSION: addr=0x100e6030*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x100e6030, 0x10202, 0xFFFFFFFF);
    ...
    */
    ...
    field_name: ug                       field_range: 0:0              field_access: wo  
    */
    REG_CLK_DIS_CHECK(0x100e6014);

    /*testing for EWR CNT: addr=0x100e6024*/
    /*
    field_name: cnt                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100e6024);
    ...
    field_name: psc                      field_range: 15:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100e6028);

    /*testing for EWR ARR: addr=0x100e602c*/
    /*
    field_name: arr                      field_range: 31:0             field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x100e602c);

    /*testing for RO IP_VERSION: addr=0x100e6030*/
    /*
    field_name: version_num              field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x100e6030);
    ...
    #ifdef MISC_HAS_BASIC_TIMER6_RST

    basic_timer6_set_rst(DISABLE);
