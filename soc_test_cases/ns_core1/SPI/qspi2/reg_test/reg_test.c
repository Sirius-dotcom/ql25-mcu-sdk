...
uint32_t volatile delta_mcycle2;
    ...
    */
    REG_DefVal_CHECK(0x1c001028,0x10001);

    /*testing for  DELAY1: addr=0x1c00102c*/
    /*
    field_name: reserved                 field_range: 31:24            field_access: ro  
    ...
    */
    REG_DefVal_CHECK(0x1c00102c,0x3);

    /*testing for RO FIFO_NUM: addr=0x1c001030*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1c001030,0x0);

    /*testing for  TXDATA: addr=0x1c001048*/
    /*
    field_name: spi_txdata               field_range: 31:0             field_access: wo  
    */
    REG_DefVal_CHECK(0x1c001048,0x0);

    /*testing for  TX_MARK: addr=0x1c001050*/
    /*
    field_name: reserved                 field_range: 31:3             field_access: ro  
    field_name: spi_tx_mark              field_range: 2:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x1c001050,0x0);

    /*testing for  RX_MARK: addr=0x1c001054*/
    /*
    field_name: reserved                 field_range: 31:3             field_access: ro  
    field_name: spi_rx_mark              field_range: 2:0              field_access: rw  
    */
    REG_DefVal_CHECK(0x1c001054,0x0);

    /*testing for  IE: addr=0x1c001070*/
    /*
    ...
    */
    REG_DefVal_CHECK(0x1c001070,0x0);

    /*testing for  SDR_SCKSAMPLE: addr=0x1c001080*/
    /*
    field_name: reserved                 field_range: 31:12            field_access: ro  
    field_name: spi_sdr_scksample        field_range: 11:0             field_access: rw  
    */
    REG_DefVal_CHECK(0x1c001080,0x0);
    ...
    field_name: spi_sckdiv               field_range: 11:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001000, 0x4, (0x00000000 & 0xfff | 0), 0x0, 0xfff);

    REG_PWR_Double_Check(0x1c001000, 0x4, (0xFFFFFFFF & 0xfff | 0), 0xfff, 0xfff);

    REG_PWR_Double_Check(0x1c001000, 0x4, (0x55555555 & 0xfff | 0), 0x555, 0xfff);

    REG_PWR_Double_Check(0x1c001000, 0x4, (0xAAAAAAAA & 0xfff | 0), 0xaaa, 0xfff);
    ...
    field_name: spi_cpha                 field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001004, 0x0, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x1c001004, 0x0, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x1c001004, 0x0, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x1c001004, 0x0, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);
    ...
    field_name: spi_ddr_scksample        field_range: 11:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001008, 0x0, (0x00000000 & 0xfff | 0), 0x0, 0xfff);

    REG_PWR_Double_Check(0x1c001008, 0x0, (0xFFFFFFFF & 0xfff | 0), 0xfff, 0xfff);

    REG_PWR_Double_Check(0x1c001008, 0x0, (0x55555555 & 0xfff | 0), 0x555, 0xfff);

    REG_PWR_Double_Check(0x1c001008, 0x0, (0xAAAAAAAA & 0xfff | 0), 0xaaa, 0xfff);
    ...
    field_name: spi_force_en             field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c00100c, 0x1, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x1c00100c, 0x1, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x1c00100c, 0x1, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x1c00100c, 0x1, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);
    ...
    field_name: spi_csid                 field_range: 2:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001010, 0x1, (0x00000000 & 0x7 | 0), 0x0, 0x7);

    REG_PWR_Double_Check(0x1c001010, 0x1, (0xFFFFFFFF & 0x7 | 0), 0x7, 0x7);

    REG_PWR_Double_Check(0x1c001010, 0x1, (0x55555555 & 0x7 | 0), 0x5, 0x7);

    REG_PWR_Double_Check(0x1c001010, 0x1, (0xAAAAAAAA & 0x7 | 0), 0x2, 0x7);
    ...
    field_name: spi_csdef                field_range: 3:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001014, 0xf, (0x00000000 & 0xf | 0), 0x0, 0xf);

    REG_PWR_Double_Check(0x1c001014, 0xf, (0xFFFFFFFF & 0xf | 0), 0xf, 0xf);

    REG_PWR_Double_Check(0x1c001014, 0xf, (0x55555555 & 0xf | 0), 0x5, 0xf);

    REG_PWR_Double_Check(0x1c001014, 0xf, (0xAAAAAAAA & 0xf | 0), 0xa, 0xf);
    ...
    field_name: spi_csmode               field_range: 1:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001018, 0x0, (0x00000000 & 0x3 | 0), 0x0, 0x3);

    REG_PWR_Double_Check(0x1c001018, 0x0, (0xFFFFFFFF & 0x3 | 0), 0x3, 0x3);

    REG_PWR_Double_Check(0x1c001018, 0x0, (0x55555555 & 0x3 | 0), 0x1, 0x3);

    REG_PWR_Double_Check(0x1c001018, 0x0, (0xAAAAAAAA & 0x3 | 0), 0x2, 0x3);

    /*testing for RO VERSION: addr=0x1c00101c*/
    /*
    field_name: spi_version              field_range: 31:0             field_access: ro  
    */
    REG_RO_Double_Check(0x1c00101c, 0x20203, 0xFFFFFFFF);
    ...
    field_name: spi_cssck                field_range: 7:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001028, 0x10001, (0x00000000 & 0xff00ff | 0), 0x0, 0xff00ff);

    REG_PWR_Double_Check(0x1c001028, 0x10001, (0xFFFFFFFF & 0xff00ff | 0), 0xff00ff, 0xff00ff);

    REG_PWR_Double_Check(0x1c001028, 0x10001, (0x55555555 & 0xff00ff | 0), 0x550055, 0xff00ff);

    REG_PWR_Double_Check(0x1c001028, 0x10001, (0xAAAAAAAA & 0xff00ff | 0), 0xaa00aa, 0xff00ff);
    ...
    field_name: spi_intercs              field_range: 7:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c00102c, 0x3, (0x00000000 & 0xff00ff | 0), 0x0, 0xff00ff);

    REG_PWR_Double_Check(0x1c00102c, 0x3, (0xFFFFFFFF & 0xff00ff | 0), 0xff00ff, 0xff00ff);

    REG_PWR_Double_Check(0x1c00102c, 0x3, (0x55555555 & 0xff00ff | 0), 0x550055, 0xff00ff);

    REG_PWR_Double_Check(0x1c00102c, 0x3, (0xAAAAAAAA & 0xff00ff | 0), 0xaa00aa, 0xff00ff);
    ...
    field_name: spi_tx_num               field_range: 2:0              field_access: ro  
    */
    REG_RO_Double_Check(0x1c001030, 0x0, 0xFFFFFFFF);

    /*testing for  TXDATA: addr=0x1c001048*/
    /*
    field_name: spi_txdata               field_range: 31:0             field_access: wo  
    */
    REG_PWR_Double_Check(0x1c001048, 0x0, (0x00000000 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1c001048, 0x0, (0xFFFFFFFF & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1c001048, 0x0, (0x55555555 & 0x0 | 0), 0x0, 0x0);

    REG_PWR_Double_Check(0x1c001048, 0x0, (0xAAAAAAAA & 0x0 | 0), 0x0, 0x0);
    ...
    field_name: spi_tx_mark              field_range: 2:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001050, 0x0, (0x00000000 & 0x7 | 0), 0x0, 0x7);

    REG_PWR_Double_Check(0x1c001050, 0x0, (0xFFFFFFFF & 0x7 | 0), 0x7, 0x7);

    REG_PWR_Double_Check(0x1c001050, 0x0, (0x55555555 & 0x7 | 0), 0x5, 0x7);

    REG_PWR_Double_Check(0x1c001050, 0x0, (0xAAAAAAAA & 0x7 | 0), 0x2, 0x7);
    ...
    field_name: spi_rx_mark              field_range: 2:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001054, 0x0, (0x00000000 & 0x7 | 0), 0x0, 0x7);

    REG_PWR_Double_Check(0x1c001054, 0x0, (0xFFFFFFFF & 0x7 | 0), 0x7, 0x7);

    REG_PWR_Double_Check(0x1c001054, 0x0, (0x55555555 & 0x7 | 0), 0x5, 0x7);

    REG_PWR_Double_Check(0x1c001054, 0x0, (0xAAAAAAAA & 0x7 | 0), 0x2, 0x7);
    ...
    field_name: spi_tx_irq_en            field_range: 0:0              field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001070, 0x0, (0x00000000 & 0x58bf | 0), 0x0, 0x58bf);

    REG_PWR_Double_Check(0x1c001070, 0x0, (0xFFFFFFFF & 0x58bf | 0), 0x58bf, 0x58bf);

    REG_PWR_Double_Check(0x1c001070, 0x0, (0x55555555 & 0x58bf | 0), 0x5015, 0x58bf);

    REG_PWR_Double_Check(0x1c001070, 0x0, (0xAAAAAAAA & 0x58bf | 0), 0x8aa, 0x58bf);
    ...
    field_name: spi_sdr_scksample        field_range: 11:0             field_access: rw  
    */
    REG_PWR_Double_Check(0x1c001080, 0x0, (0x00000000 & 0xfff | 0), 0x0, 0xfff);

    REG_PWR_Double_Check(0x1c001080, 0x0, (0xFFFFFFFF & 0xfff | 0), 0xfff, 0xfff);

    REG_PWR_Double_Check(0x1c001080, 0x0, (0x55555555 & 0xfff | 0), 0x555, 0xfff);

    REG_PWR_Double_Check(0x1c001080, 0x0, (0xAAAAAAAA & 0xfff | 0), 0xaaa, 0xfff);
    ...
    */
    ...
    field_name: spi_csmode               field_range: 1:0              field_access: rw  
    */
    REG_CLK_DIS_CHECK(0x1c001018);

    /*testing for RO VERSION: addr=0x1c00101c*/
    /*
    field_name: spi_version              field_range: 31:0             field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x1c00101c);
    ...
    */
    ...
    field_name: spi_tx_num               field_range: 2:0              field_access: ro  
    */
    REG_CLK_DIS_CHECK(0x1c001030);

    /*testing for  TXDATA: addr=0x1c001048*/
    /*
    field_name: spi_txdata               field_range: 31:0             field_access: wo  
    */
    REG_CLK_DIS_CHECK(0x1c001048);
