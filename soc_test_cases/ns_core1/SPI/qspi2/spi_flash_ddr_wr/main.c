...
void main(void)
{
    ...
    Spi_NorFlash_Read(QSPI2, FLASH_DdrReadData, read_buf, FLASH_ADDR, FLASH_PAGESIZE);
    ...
    Spi_NorFlash_Read(QSPI2, FLASH_DdrReadDual, read_buf, FLASH_ADDR, FLASH_PAGESIZE);
    if (0 == memcmp(write_buf, read_buf, FLASH_PAGESIZE)) {
    ...
    Spi_NorFlash_Read(QSPI2, FLASH_DdrReadQuad, read_buf, FLASH_ADDR, FLASH_PAGESIZE);
