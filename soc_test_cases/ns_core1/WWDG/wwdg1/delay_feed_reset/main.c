...
#define POR_FLAG ~(RESET_CTRL0_WWDG1_WDOGRES | RESET_CTRL_BROM_CPU_RST_N_O)
#else
...
int main(void)
{
    ...
    wwdg_config(WWDG1,0x43, 80, WWDG_CFR_WDGTB_DIV_1);
    #else
    wwdg_config(WWDG1,127, 80, WWDG_CFR_WDGTB_DIV_8);
    #endif
