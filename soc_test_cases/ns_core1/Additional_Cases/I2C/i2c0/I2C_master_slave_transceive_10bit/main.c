...
void main(void)
{
    ...
    I2C_MasterRecvSlaveSend_10bit(I2C0, I3, I3_SLAVE_ADDRESS1, i2c_slv_send, i2c_mst_recv, BUFSIZE);

    I2C_MasterSendSlaveRecv_10bit(I2C0, I3, I3_SLAVE_ADDRESS1, i2c_mst_send, i2c_slv_recv, BUFSIZE);
