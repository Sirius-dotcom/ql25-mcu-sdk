...
{
    if ((SET == I2C_Get_IntStatus(I2C0, I2C_INT_IE_EOT_ENABLE)) && (SET == I2C_Get_Status(I2C0, I2C_STATUS_EOT))) {
...
void main(void)
{
    ...
    I2C_Set_TxSize(I2C0, BUFFER_SIZE*4);
    I2C_Set_RxSize(I3, BUFFER_SIZE*4);

    I2C_RxDma_Start(I3, ENABLE);
    I2C_TxDma_Start(I2C0, ENABLE);
