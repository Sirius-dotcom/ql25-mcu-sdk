...
{
    test_flag = 0;
    if(I2C_Get_IntStatus(I2C0, I2C_INT_IE_ARBITRATION_LOST_ENABLE) && I2C_Get_Status(I2C0, I2C_STATUS_ARB_LOST))
    {
        
        I2C_IntStatus_Clear(I2C0, I2C_STATUS_ARB_LOST);
        I2C_Interrupt_En(I2C0, I2C_INT_IE_ARBITRATION_LOST, DISABLE);
        arb_flag = SUCCESS;
    }
    if(I2C_Get_IntStatus(I2C0, I2C_INT_IE_NACK_RECEPTION_ENABLE) && I2C_Get_Status(I2C0, I2C_STATUS_NACK))
    {
        
        I2C_IntStatus_Clear(I2C0, I2C_STATUS_NACK);
        I2C_Interrupt_En(I2C0, I2C_INT_IE_NACK_RECEPTION, DISABLE);
    }
    if(I2C_Get_IntStatus(I2C0, I2C_INT_IE_ADDR_MATCH_ENABLE) && I2C_Get_Status(I2C0, I2C_STATUS_ADDR_MATCH))
    {
        
        I2C_IntStatus_Clear(I2C0, I2C_STATUS_ADDR_MATCH);
        I2C_Interrupt_En(I2C0, I2C_INT_IE_ADDR_MATCH, DISABLE);
        addr_match1 = 1;
    }
    if(I2C_Get_IntStatus(I2C0, I2C_INT_IE_TXFIFO_WM_ENABLE) && I2C_Get_Status(I2C0, I2C_STATUS_TXFIFO_WM))
    {
        
        I2C_Interrupt_En(I2C0, I2C_INT_IE_TXFIFO_WM, DISABLE);
        test_cs = MST_RX_WM;
    }
    if(I2C_Get_IntStatus(I2C0, I2C_INT_IE_RXFIFO_WM_ENABLE) && I2C_Get_Status(I2C0, I2C_STATUS_RXFIFO_WM))
    {
        
        I2C_Interrupt_En(I2C0, I2C_INT_IE_RXFIFO_WM, DISABLE);
    ...
    if(I2C_Get_IntStatus(I2C0, I2C_INT_IE_TIME_OUT_ENABLE) && I2C_Get_Status(I2C0, I2C_STATUS_TIME_OUT))
    {
        
        I2C_TimeOut_En(I2C0, DISABLE);
        I2C_IntStatus_Clear(I2C0, I2C_STATUS_TIME_OUT);
        I2C_Interrupt_En(I2C0, I2C_INT_IE_TIME_OUT, DISABLE);
        test_cs = MST_TX_WM;
    }
}
...
static inline void addr_match_test(void)
{
    ...
    I2C0->TXDATA = (I3_SLAVE_ADDRESS1 << 1 | I2C_DIR_READ);
    ...
    while (!I2C_Get_Status(I2C0,I2C_STATUS_BYTE_DONE)) {}
    i2c_mst_recv[0] = I2C0->RXDATA;
    I2C_Stop(I2C0);
...
static inline void i2c_arb_lost_test(void)
{
    ...
    I2C0->TXDATA = ARB_DATA;
    I3->TXDATA = PRIOR_DATA;
    I2C0->SETUP |= I2C_SETUP_START;
    I3->SETUP |= I2C_SETUP_START;
    while (I2C0->SETUP & I2C_SETUP_START){}
...
void main(void)
{
    ...
    while(1) {
        switch(test_cs) {
            case MST_ARBT_LOST:
                test_cs = TEST_MAX;
                I2C_Interrupt_En(I2C0, I2C_INT_IE_ARBITRATION_LOST, ENABLE);
                i2c_arb_lost_test();
                while(test_flag);
                test_flag = 1;
                break;
            case MST_TIME_OUT:
                test_cs = TEST_MAX;
                I2C_TimeOut_En(I2C0, ENABLE);
                I2C_TimeOut_Cfg(I2C0, 0x10);
                I2C0->TXDATA = 0x00;
                I2C_Start(I2C0);
                I2C_Stop(I2C0);
                I2C_Interrupt_En(I2C0, I2C_INT_IE_TIME_OUT, ENABLE);
                I2C_WaitStopOver(I2C0);
                while(test_flag);
                test_flag = 1;
                break;
            case MST_NACK_RECP:
                test_cs = TEST_MAX;
                I2C_Config();
                I2C_Interrupt_En(I2C0, I2C_INT_IE_NACK_RECEPTION, ENABLE);
            ...
            case MST_ADDR_MATCH:
                test_cs = TEST_MAX;
                I2C_Interrupt_En(I2C0, I2C_INT_IE_ADDR_MATCH, ENABLE);
                addr_match_test();
            ...
            case MST_TX_WM:
                test_cs = TEST_MAX;
                I2C_Interrupt_En(I2C0, I2C_INT_IE_TXFIFO_WM, ENABLE);
            ...
            case MST_RX_WM:
                ...
                #endif
                I2C_Config();
                I2C_Interrupt_En(I2C0, I2C_INT_IE_RXFIFO_WM, ENABLE);
                I2C_Set_RxWaterMark(I2C0, 0);
                i2c_rx_watermark_test(I2C0, I3, I3_SLAVE_ADDRESS1, i2c_slv_send, i2c_mst_recv, 1);
                while(test_flag);
                test_flag = 1;
                break;
            case MST_EOT:
                ...
                I2C_MasterRecvSlaveSend_Onebyone(I2C0, I3, I3_SLAVE_ADDRESS1, i2c_slv_send, i2c_mst_recv, 1);
                I2C_Config();
                while(test_flag);
                test_flag = 1;
                break;
