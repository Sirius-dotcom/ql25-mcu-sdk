...
void XKAN2_IRQHandler(void)
{
    ...
    if(xKan_GetInterruptStatus(XKAN2, XKAN_CFG_INT_STATUS_RXF1_WM_INT) && xKan_GetInterruptEnable(XKAN2, XKAN_CFG_INT_EN_RXF1_WM_EN))
    {
        ...
        if (remote_filter_miss_reject) xKan_EnableInterrupt(XKAN2, XKAN_CFG_INT_EN_RXF1_WM_EN, DISABLE);
    }
    ...
    if(xKan_GetInterruptStatus(XKAN2, XKAN_CFG_INT_STATUS_RXB_UPD_INT) && xKan_GetInterruptEnable(XKAN2, XKAN_CFG_INT_EN_RXB_UPD_EN))
    {
        ...
        pRxData += BUFSIZE;
        if (rx_buf_done == 1) xKan_EnableInterrupt(XKAN2, XKAN_CFG_INT_EN_RXB_UPD_EN, DISABLE);
    }
}
...
void main(void)
{
    ...
    xKan_EnableInterrupt(XKAN2, XKAN_CFG_INT_STATUS_RXB_UPD_INT, ENABLE);
    ...
    xKan_ConfigGlobalFilter(XKAN2, XKAN_ACCEPT_IN_RX_FIFO0, XKAN_ACCEPT_IN_RX_FIFO0, XKAN_FILTER_REMOTE, XKAN_FILTER_REMOTE);
    /*send remote frame(dlc:0) */
    ...
    xKan_ConfigGlobalFilter(XKAN2, XKAN_ACCEPT_IN_RX_FIFO0, XKAN_ACCEPT_IN_RX_FIFO0, XKAN_REJECT_REMOTE, XKAN_REJECT_REMOTE);
    /*send remote frame(dlc:0) */
