...
Function description:
    This demo shows the {per_inst} communication with {per1_inst} through CAN2.0 remote frame protocol in normal mode with reject remote frame and accept miss frame into fifo,
