...
void main(void)
{
    ...
    * 5.clear status
    * */
    clk_stop_status1= xKan_ClkStop(XKAN0, ENABLE);
    clk_stop_status2 = xKan_ClkStop(XKAN1, ENABLE);

    clk_stop_status1 &= xKan_ClkStop(XKAN0, DISABLE);
    clk_stop_status2 &= xKan_ClkStop(XKAN1, DISABLE);
