...
Function description:
    This demo shows the {per_inst} communication with {per1_inst} through CANFD data frame protocol in normal mode with BRS on to test xkan normal interrupt,
and then compares the consistency of the sent and received data.

Test result:
    If interrupts could normal triggers, print pass, if not print fail.
