Spi_master_slave_padma_continuous
=================================

Function description:
---------------------
This demo shows master send data and slave receive data use UDMA continuous mode, in addition, data is initialized to sram.
...
-------------  -------------  --------------------  --------------------  -----------------
  continuous      40 bytes       non-increasing          increasing            32 bits  
=============  =============  ====================  ====================  =================
...
==============  =============  ====================  ====================  =================  
    Mode         buffer size     Dst Address Mode      Src Address Mode     Transfer Width    
--------------  -------------  --------------------  --------------------  -----------------
  continuous      40 bytes        increasing           non-increasing          32 bits  
==============  =============  ====================  ====================  =================
