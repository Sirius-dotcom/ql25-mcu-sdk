Spi_master_slave_padma_all
==========================

Function description:
---------------------
This demo shows master send slave receive and master receive slave send data use UDMA mode, in addition, data is initialized to sram.
...
Test result:
------------
If the data of slave transceiving is equal to master transceiving, print pass, if not print fail.
