...
---------------------
    Connect two groups of USART according to the connection mode, send 
    data through USART_TX, USART1_RX receives data and stores 
    it in USART1_buffer.Similarly, USART1_TX sends data, USART_RX 
    receives data and stores it in USART_buffer.
